...
public class JoinInvitationRepository(LocationDbContext dbContext, TimeProvider timeProvider)
    : RepositoryBase<LocationDbContext, JoinInvitation>(dbContext, timeProvider), IJoinInvitationRepository
{
    ...
    public async Task<ICollection<JoinInvitation>> GetPendingByEmailAsync(
        ...
        .Where(query => !query.DeletedAt.HasValue &&
                        query.NewStatus == InvitationStatus.Pending && emails.Any(email =>

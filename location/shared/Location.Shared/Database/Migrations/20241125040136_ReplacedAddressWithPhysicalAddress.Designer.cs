...
namespace Location.Shared.Database.Migrations
{
    ...
    [Migration("20241125040136_ReplacedAddressWithPhysicalAddress")]
    partial class ReplacedAddressWithPhysicalAddress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Location.Shared.Database.Entities.Tag", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("DeskTag", b =>
                {
                    ...
                    b.HasOne("Location.Shared.Database.Entities.Tag", null)
                        .WithMany()

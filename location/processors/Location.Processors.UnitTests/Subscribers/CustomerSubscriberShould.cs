...
using CustomerModel = Location.Shared.Models.Customer;
using CustomerEntity = Location.Shared.Database.Entities.Customer;

namespace Location.Processors.UnitTests.Subscribers;

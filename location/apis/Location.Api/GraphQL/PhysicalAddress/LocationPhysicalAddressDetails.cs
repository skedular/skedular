...
[GraphQLName("LocationPhysicalAddressDetails")]
public class LocationPhysicalAddressDetails : Node
{
    ...
    [GraphQLName("organization")] public LocationDetails Location { get; set; } = new();

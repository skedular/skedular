...
public class PrivateFile : EntityBase
{
...
public class PrivateFileConfiguration : IEntityTypeConfiguration<PrivateFile>
{
    public void Configure(EntityTypeBuilder<PrivateFile> builder)
    {
        ...
        builder.HasOne(item => item.UploadedBy).WithMany(item => item.PrivateFiles);

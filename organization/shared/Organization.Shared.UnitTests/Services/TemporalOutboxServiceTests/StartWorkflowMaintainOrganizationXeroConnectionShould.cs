...
public class StartWorkflowMaintainOrganizationXeroConnectionShould
{
    [Theory]
    [AutoFakeItEasyData]
    public void Enqueue_Workflow_With_Correct_Options(
        ...
        MaintainOrganizationXeroConnectionInput args,
        IUnitOfWork unitOfWork,
        string expectedId)
    {
        A.CallTo(() => workflowIdService.MaintainOrganizationXeroConnection(args.OrganizationId)).Returns(expectedId);

        sut.StartWorkflowMaintainOrganizationXeroConnection(args, unitOfWork);

        A.CallTo(() => temporalOutboxWorkflowExecutor.Execute<MaintainOrganizationXeroConnection, MaintainOrganizationXeroConnectionInput>(
            args,

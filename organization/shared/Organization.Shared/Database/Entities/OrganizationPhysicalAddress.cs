...
public class OrganizationPhysicalAddress : EntityBaseWithDeleted, IAddressDetails
{
...
public class OrganizationPhysicalAddressConfiguration : IEntityTypeConfiguration<OrganizationPhysicalAddress>
{
    public void Configure(EntityTypeBuilder<OrganizationPhysicalAddress> builder)
    {

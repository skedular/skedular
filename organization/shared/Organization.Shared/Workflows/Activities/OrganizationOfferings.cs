...
public record RenewAutoRenewableOrganizationOfferingAsyncInput(string OrganizationId);
    ...
    IOrganizationOutboxPublisher organizationOutboxPublisher)
{
    ...
    public async Task<string?> RenewAutoRenewableOrganizationOfferingAsync(RenewAutoRenewableOrganizationOfferingAsyncInput args)
    {
        ...
        var expiredOfferingsRequireAutoRenew = await repositoryFactory.OrganizationOfferingRepository.GetExpiredAutoRenewableOfferingsAsync(
            args.OrganizationId,
            cancellationToken);
        ...
        return expiredOfferingRequireAutoRenew.Id;
    }
}

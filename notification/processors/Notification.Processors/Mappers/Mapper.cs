...
public interface IMapper
{
    ...
    Shared.Models.Notification MapToNotification(Api.Shared.Clients.Events.UnityHub.Location.V1.Value.Event src);
    Shared.Models.Notification MapToNotification(Api.Shared.Clients.Events.UnityHub.Team.V1.Value.Event src);
...
public class Mapper(IRandomHelper randomHelper) : IMapper
{
    ...
    public Team MapTo(Api.Shared.Clients.Events.UnityHub.Team.V1.Value.Event src)
    {
        ...
        var team = new Team
        {
            Id = teamAfterState.Id, DeletedAt = deletedAt, EventRaisedAt = eventRaisedAt, Name = teamAfterState.Name
        };
    ...
    public Shared.Models.Notification MapToNotification(Api.Shared.Clients.Events.UnityHub.Location.V1.Value.Event src)
    {
        var notification = src.Data.NotificationAfterState;
        var deletedAt = notification.DeletedAt?.ToDateTimeOffset();
        var eventRaisedAt = src.Metadata.Time?.ToDateTimeOffset() ?? DateTimeOffset.MinValue;
        ...
        return new Shared.Models.Notification
        {
            ...
            InvitedBy =
                new Shared.Models.Customer { Id = notification.InvitationToJoinLocationDetails.InvitedById },
            Invitee = new Shared.Models.Customer { Id = notification.InvitationToJoinLocationDetails.InviteeId },
            Location = new Location { Id = notification.InvitationToJoinLocationDetails.LocationId }
        };
    }

    public Shared.Models.Notification MapToNotification(Api.Shared.Clients.Events.UnityHub.Team.V1.Value.Event src)
    {
        var notification = src.Data.NotificationAfterState;
        var deletedAt = notification.DeletedAt?.ToDateTimeOffset();
        var eventRaisedAt = src.Metadata.Time?.ToDateTimeOffset() ?? DateTimeOffset.MinValue;
        ...
        return new Shared.Models.Notification
        {
            ...
            InvitedBy =
                new Shared.Models.Customer { Id = notification.InvitationToJoinTeamDetails.InvitedById },
            Invitee = new Shared.Models.Customer { Id = notification.InvitationToJoinTeamDetails.InviteeId },
            Team = new Team { Id = notification.InvitationToJoinTeamDetails.TeamId }
        };
    }

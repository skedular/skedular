...
public class CustomerRepository(NotificationDbContext dbContext, TimeProvider timeProvider, IGenericCustomerCacheService genericCustomerCacheService)
    : RepositoryBase<NotificationDbContext, Customer>(dbContext, timeProvider), ICustomerRepository
{

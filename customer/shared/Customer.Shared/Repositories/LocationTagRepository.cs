...
public class LocationTagRepository(CustomerDbContext dbContext, TimeProvider timeProvider)
    : RepositoryBase<CustomerDbContext, LocationTag>(dbContext), ILocationTagRepository
{

...
namespace Customer.Shared.Database.Migrations
{
    ...
    [Migration("20250305063757_RenamedLocationsResourceToResourcesInLocationModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Customer.Shared.Database.Entities.Room", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("Customer.Shared.Database.Entities.LocationResource", b =>
                {
                    ...
                    b.HasOne("Customer.Shared.Database.Entities.OrganizationResourceType", "OrganizationResourceType")
            ...
            modelBuilder.Entity("CustomerLocationResource", b =>
                {
                    ...
                    b.HasOne("Customer.Shared.Database.Entities.LocationResource", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CustomerRoom", b =>
                {
                    ...
                    b.HasOne("Customer.Shared.Database.Entities.Room", null)
                        .WithMany()

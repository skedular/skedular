...
resource "aws_ssm_parameter" "new_customer_joined_email_template" {
  name  = module.common.parameter_store_name_new_customer_joined_email_template_arn
  type  = "String"
  value = aws_ses_template.new_customer_joined_email_template.arn
  tags  = merge(local.tags, module.common.tags)
}

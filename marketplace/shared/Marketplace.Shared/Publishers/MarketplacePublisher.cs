...
{
    Task PublishProductsAsync(ICollection<Product> products, CancellationToken cancellationToken);
}
...
{
    public async Task PublishProductsAsync(ICollection<Product> products, CancellationToken cancellationToken) =>

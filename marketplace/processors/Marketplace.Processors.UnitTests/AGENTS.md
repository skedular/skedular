# Marketplace Processors Unit Tests Notes

This file applies to `marketplace/processors/Marketplace.Processors.UnitTests`.

## Purpose

- Unit tests for the marketplace processors host.

...
var bookingApi = builder
    ...
    .WithEnvironment("ASPNETCORE_ENVIRONMENT", Environments.Production)
    .WithEnvironment("Booking__GrpcUrl", "https+http://bookingapi")
    .WithEnvironment("Core__GrpcUrl", "https+http://coreapi")
    .WithEnvironment("Customer__GrpcUrl", "https+http://customerapi")
    .WithEnvironment("Location__GrpcUrl", "https+http://locationapi")
    .WithEnvironment("Marketplace__GrpcUrl", "https+http://marketplaceapi")
    .WithEnvironment("MsTeams__GrpcUrl", "https+http://msteamsapi")
    .WithEnvironment("Organization__GrpcUrl", "https+http://organizationapi")
    .WithEnvironment("Slack__GrpcUrl", "https+http://slackapi")
    .WithEnvironment("Team__GrpcUrl", "https+http://teamapi")
    .WithHttpHealthCheck(Constants.ReadinessPath)
    .WithReference(kafka)
    .WithReference(temporal)
    .WithReference(redis)
...
_ = builder
    ...
    .WithEnvironment("ASPNETCORE_ENVIRONMENT", Environments.Production)
    .WithEnvironment("Subgraphs__Booking__Uri", string.Empty)
    .WithEnvironment("Subgraphs__Core__Uri", string.Empty)
    .WithEnvironment("Subgraphs__Customer__Uri", string.Empty)
    .WithEnvironment("Subgraphs__Location__Uri", string.Empty)
    .WithEnvironment("Subgraphs__Marketplace__Uri", string.Empty)
    .WithEnvironment("Subgraphs__MsTeams__Uri", string.Empty)
    .WithEnvironment("Subgraphs__Organization__Uri", string.Empty)
    .WithEnvironment("Subgraphs__Slack__Uri", string.Empty)
    .WithEnvironment("Subgraphs__Team__Uri", string.Empty)

    ...
    : IMigrationService
{
    ...
    private async Task CreateTopicsAsync()
    {
        ...
        // await kafkaHelper.RegisterKeyProtobufSchemaAsync<Api.Shared.Clients.Events.Skedular.PaymentInternal.V1.Key.Key>();
        // await kafkaHelper.RegisterValueProtobufSchemaAsync<Api.Shared.Clients.Events.Skedular.PaymentInternal.V1.Value.Event>();
    }
}

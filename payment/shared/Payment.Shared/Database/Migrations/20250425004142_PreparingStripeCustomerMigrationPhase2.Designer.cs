...
namespace Payment.Shared.Database.Migrations
{
    ...
    [Migration("20250425004142_PreparingStripeCustomerMigrationPhase2")]
    partial class PreparingStripeCustomerMigrationPhase2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Payment.Shared.Database.Entities.Organization", b =>
                {
                    ...
                    b.Property<string>("StripeCustomerIdTemp")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.HasIndex("StripeCustomerIdTemp");

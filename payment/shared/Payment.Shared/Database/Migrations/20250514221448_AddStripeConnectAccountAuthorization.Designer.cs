...
namespace Payment.Shared.Database.Migrations
{
    ...
    [Migration("20250514221448_AddStripeConnectAccountAuthorization")]
    partial class AddStripeConnectAccountAuthorization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Payment.Shared.Database.Entities.StripeConnectAccountAuthorization", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.ToTable("StripeConnectAccountAuthorization");
                });
            ...
            modelBuilder.Entity("Payment.Shared.Database.Entities.StripeConnectAccountAuthorization", b =>
                {
                    b.HasOne("Payment.Shared.Database.Entities.StripeConnectAccount", "StripeConnectAccount")
                        .WithOne("StripeConnectAccountAuthorization")
                        .HasForeignKey("Payment.Shared.Database.Entities.StripeConnectAccountAuthorization", "StripeConnectAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Payment.Shared.Database.Entities.StripeConnectAccount", b =>
                {
                    b.Navigation("StripeConnectAccountAuthorization");

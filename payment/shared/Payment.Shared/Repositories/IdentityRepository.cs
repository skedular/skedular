...
public class IdentityRepository(PaymentDbContext dbContext, TimeProvider timeProvider)
    : RepositoryBase<PaymentDbContext, Identity>(dbContext, timeProvider), IIdentityRepository
{

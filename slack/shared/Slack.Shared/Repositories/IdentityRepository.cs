...
public class IdentityRepository(SlackDbContext dbContext, TimeProvider timeProvider)
    : RepositoryBase<SlackDbContext, Identity>(dbContext, timeProvider), IIdentityRepository
{

...
public class RemoveDeskTypeButtonHandler(
    ...
    IPageNavigator pageNavigator) : IViewSubmissionHandler
{
    public async Task<ViewSubmissionResponse> Handle(ViewSubmission viewSubmission)
    {
        ...
        var context = RemoveDeskTypeContext.Deserialize(viewSubmission.View.PrivateMetadata);
        ...
        await organizationServiceClient.RemoveDeskTypeAsync(
            new RemoveDeskTypeInput { Id = context.DeskTypeId },

...
using CustomerModel = Slack.Shared.Models.Customer;
using CustomerEntity = Slack.Shared.Database.Entities.Customer;

namespace Slack.Processors.UnitTests.Subscribers;

...
public class CustomerSubscriberShould
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        A.CallTo(() => customerRepository.UpsertNakedAsync(customerId, false, cancellationToken)).Returns(existing);
        ...
        CancellationToken cancellationToken)
    {
        ...
        A.CallTo(() => repositoryFactory.UnitOfWork).Returns(unitOfWork);
        A.CallTo(() => eventMapper.MapTo(@event)).Returns(model);
        A.CallTo(() => customerRepository.GetByIdAsync(customerId, false, cancellationToken)).Returns(existing);
        A.CallTo(() => unitOfWork.SaveChangesAsync(cancellationToken)).Returns(1);

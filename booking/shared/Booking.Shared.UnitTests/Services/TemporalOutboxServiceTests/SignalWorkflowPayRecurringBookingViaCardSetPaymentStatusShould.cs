...
public class SignalWorkflowPayRecurringBookingViaCardSetPaymentStatusShould
{
    [Theory]
    [AutoFakeItEasyData]
    ...
    {
        A.CallTo(() => workflowIdService.PayRecurringBookingViaCard(recurringBookingId)).Returns(expectedWorkflowId);

        sut.SignalWorkflowPayRecurringBookingViaCardSetPaymentStatus(recurringBookingId, executionArgs, unitOfWork);

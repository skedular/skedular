...
public class IsXeroManagedForArrearsShould
{
    [Fact]
    ...
    private static bool Invoke(XeroConnection xeroConnection) =>
        (bool)(typeof(OrganizationArrearsBillingIntegrations)
            .GetMethod("IsXeroManagedForArrears", BindingFlags.Static | BindingFlags.NonPublic)!

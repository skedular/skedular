...
dep-restart:
	docker compose -p unityhubio -f docker-compose-production.yml --env-file .env pull
	docker compose -p unityhubio -f docker-compose-production.yml --env-file .env down dozzle postgres17 redis redisinsight kafka1 schema-registry kowl zipkin jaeger
	docker compose -p unityhubio -f docker-compose-production.yml --env-file .env up --build -d dozzle postgres17 redis redisinsight kafka1 schema-registry kowl zipkin jaeger

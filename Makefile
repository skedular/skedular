...
services-restart:
	docker compose -p unityhubio -f docker-compose-production.yml --env-file .env pull
	docker compose -p unityhubio -f docker-compose-production.yml --env-file .env build
	docker compose -p unityhubio -f docker-compose-production.yml --env-file .env down temporal temporal-admin-tools temporal-ui staging-infra-provision staging-processors-01 staging-jobs-01 staging-apis-01 prod-infra-provision prod-processors-01 prod-apis-01 prod-jobs-01 prod-apis-01
	docker compose -p unityhubio -f docker-compose-production.yml --env-file .env up --build -d temporal temporal-admin-tools temporal-ui staging-infra-provision staging-processors-01 staging-jobs-01 staging-apis-01 prod-infra-provision prod-processors-01 prod-apis-01 prod-jobs-01 prod-apis-01

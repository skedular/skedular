...
dep-restart:
	docker compose -p unityhubio -f docker-compose-production.yml --env-file .env pull
	docker compose -p unityhubio -f docker-compose-production.yml --env-file .env down dozzle postgres redis kafka1 kowl zipkin jaeger
	docker compose -p unityhubio -f docker-compose-production.yml --env-file .env up --build -d dozzle postgres redis kafka1 kowl zipkin jaeger

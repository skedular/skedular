...
services-restart:
	docker compose -p unityhubio -f docker-compose-production.yml --env-file .env pull
	docker compose -p unityhubio -f docker-compose-production.yml --env-file .env build
	docker compose -p unityhubio -f docker-compose-production.yml --env-file .env down staging-temporal staging-temporal-admin-tools staging-temporal-ui prod-temporal prod-temporal-admin-tools prod-temporal-ui staging-infra-provision staging-processors-01 staging-jobs-01 staging-apis-01 prod-infra-provision prod-processors-01 prod-apis-01 prod-jobs-01 prod-apis-01
	docker compose -p unityhubio -f docker-compose-production.yml --env-file .env up --build -d staging-temporal staging-temporal-admin-tools staging-temporal-ui prod-temporal prod-temporal-admin-tools prod-temporal-ui staging-infra-provision staging-processors-01 staging-jobs-01 staging-apis-01 prod-infra-provision prod-processors-01 prod-apis-01 prod-jobs-01 prod-apis-01

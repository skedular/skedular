...
export class OrganizationService {
   ...
   * @throws ApiError
   */
  public republish(organizationId: string): CancelablePromise<any | Error> {
   ...
   * @throws ApiError
   */
  public onboardAzureTenant(tenant: string, adminConsent: boolean, state: string, error?: string, errorDescription?: string): CancelablePromise<any> {
    return this.httpRequest.request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public ssoLogin(organizationId: string): CancelablePromise<any | Error> {
    return this.httpRequest.request({
      method: 'POST',

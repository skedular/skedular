...
const SmallSubtitleIconTypography = ({ icon, stackMode, label, sx, color }: Props) => (
  <IconTypography icon={icon} stackMode={stackMode} label={label} variant="subtitle2" sx={sx} color={color} />
);

...
const BodyIconTypography = ({ icon, stackMode, label, sx, spacing, color }: Props) => (
  <IconTypography icon={icon} stackMode={stackMode} label={label} variant="body1" sx={sx} spacing={spacing} color={color} />
);

...
const SectionIconTypography = ({ icon, stackMode, label, sx, spacing, color }: Props) => (
  <IconTypography icon={icon} stackMode={stackMode} label={label} variant="h5" sx={sx} spacing={spacing} color={color} />
);

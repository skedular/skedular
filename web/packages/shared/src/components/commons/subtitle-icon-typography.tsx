...
const SubtitleIconTypography = ({ icon, stackMode, label, sx, color }: Props) => (
  <IconTypography icon={icon} stackMode={stackMode} label={label} variant="subtitle1" sx={sx} color={color} />
);

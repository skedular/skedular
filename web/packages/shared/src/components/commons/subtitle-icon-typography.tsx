...
const SubtitleIconTypography = ({ icon, stackMode, label, sx, spacing, color }: Props) => (
  <IconTypography icon={icon} stackMode={stackMode} label={label} variant="subtitle1" sx={sx} spacing={spacing} color={color} />
);

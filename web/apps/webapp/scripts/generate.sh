...
npx openapi-typescript-codegen --input ../../../api-definitions/openapi/skedular/booking_v1.yaml --output ./src/clients/openapi/skedular/v1/booking/fetch --name SkedularBookingV1Client --client fetch --exportSchemas true &
npx openapi-typescript-codegen --input ../../../api-definitions/openapi/skedular/notification_v1.yaml --output ./src/clients/openapi/skedular/v1/notification/fetch --name SkedularNotificationV1Client --client fetch --exportSchemas true &
...
npx openapi-typescript-codegen --input ../../../api-definitions/openapi/skedular/payment_v1.yaml --output ./src/clients/openapi/skedular/v1/payment/fetch --name SkedularBillingV1Client --client fetch --exportSchemas true &
npx openapi-typescript-codegen --input ../../../api-definitions/openapi/skedular/billing_v1.yaml --output ./src/clients/openapi/skedular/v1/billing/fetch --name SkedularPaymentV1Client --client fetch --exportSchemas true &

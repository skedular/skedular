...
npx openapi-typescript-codegen --input ../../../api-definitions/openapi/skedular/booking/booking_v1.yaml --output ./src/clients/openapi/skedular/v1/booking/booking/fetch --name SkedularBookingV1Client --client fetch --exportSchemas true &

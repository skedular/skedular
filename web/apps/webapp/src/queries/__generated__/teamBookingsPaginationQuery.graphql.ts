/**
 * @generated SignedSource<<294355082a72d0a33f9a43a0003ed58b>>
...
export type teamBookingsPaginationQuery$variables = {
...
export type teamBookingsPaginationQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"teamBookingsTab_query">;
};
export type teamBookingsPaginationQuery = {
  response: teamBookingsPaginationQuery$data;
  variables: teamBookingsPaginationQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "teamBookingsPaginationQuery",
    "selections": [
      {
        "args": [
          {

/**
 * @generated SignedSource<<d8ef58e066ce9eb82184dadfedf91414>>
...
import organizationMemberSelector_refetchableFragment_graphql from './organizationMemberSelector_refetchableFragment.graphql';
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": organizationMemberSelector_refetchableFragment_graphql
    }
  },
          ...
          "selections": [
            {
              ...
              "kind": "LinkedField",
              "name": "__organizationMemberSelector_members_connection",
              "plural": false,
              "selections": [
                {
                  "alias": null,
...
(node as any).hash = "7fe2ba90fd3f7d284a74e58d295166ee";

...
export type desksPaginationQuery$variables = {
...
export type desksPaginationQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"locationDesksTab_query">;
};
export type desksPaginationQuery = {
  response: desksPaginationQuery$data;
  variables: desksPaginationQuery$variables;
};

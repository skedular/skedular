/**
 * @generated SignedSource<<0edd4471168a9d041bb0a2f6e3cad1b2>>
...
export type organizationMembers_PaginationQuery$variables = {
...
export type organizationMembers_PaginationQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"organizationPeopleTab_query">;
};
export type organizationMembers_PaginationQuery = {
  response: organizationMembers_PaginationQuery$data;
  variables: organizationMembers_PaginationQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "organizationMembers_PaginationQuery",
    "selections": [
      {
        "args": [
          {

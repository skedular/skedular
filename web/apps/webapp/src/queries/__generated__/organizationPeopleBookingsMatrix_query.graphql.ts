...
export type organizationPeopleBookingsMatrix_query$data = {
  ...
  readonly " $fragmentType": "organizationPeopleBookingsMatrix_query";
};
export type organizationPeopleBookingsMatrix_query$key = {
  readonly " $data"?: organizationPeopleBookingsMatrix_query$data;

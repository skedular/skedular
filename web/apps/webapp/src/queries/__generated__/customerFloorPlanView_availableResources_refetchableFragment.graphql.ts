/**
 * @generated SignedSource<<c4f0c3874227bd18523f127619fb8f6e>>
...
export type customerFloorPlanView_availableResources_refetchableFragment$variables = {
  dateFromToGetAvailableResources: any;
  dateUntilToGetAvailableResources: any;
  locationId?: string | null | undefined;
  organizationId: string;
};
export type customerFloorPlanView_availableResources_refetchableFragment$data = {
  readonly " $fragmentSpreads": FragmentRefs<"customerFloorPlanView_availableResources_query">;
};
export type customerFloorPlanView_availableResources_refetchableFragment = {
  response: customerFloorPlanView_availableResources_refetchableFragment$data;
  variables: customerFloorPlanView_availableResources_refetchableFragment$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "customerFloorPlanView_availableResources_refetchableFragment",
    "selections": [
      {
        "args": null,
        "kind": "FragmentSpread",

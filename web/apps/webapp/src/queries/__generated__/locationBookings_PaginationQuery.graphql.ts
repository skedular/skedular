/**
 * @generated SignedSource<<3e547aac7c80c82cccf3134dcf6f07ba>>
...
export type locationBookings_PaginationQuery$variables = {
...
export type locationBookings_PaginationQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"locationBookingsTab_query">;
};
export type locationBookings_PaginationQuery = {
  response: locationBookings_PaginationQuery$data;
  variables: locationBookings_PaginationQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "locationBookings_PaginationQuery",
    "selections": [
      {
        "args": [
          {

/**
 * @generated SignedSource<<0531a10b793b54f5b085adfa50b4b503>>
...
export type teamBookingsTab_bookings_refetchableFragment$variables = {
...
export type teamBookingsTab_bookings_refetchableFragment$data = {
  readonly " $fragmentSpreads": FragmentRefs<"teamBookingsTab_bookings_query">;
};
export type teamBookingsTab_bookings_refetchableFragment = {
  response: teamBookingsTab_bookings_refetchableFragment$data;
  variables: teamBookingsTab_bookings_refetchableFragment$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "teamBookingsTab_bookings_refetchableFragment",
    "selections": [
      {
        "args": [
          {
  ...
  "params": {
    "cacheID": "3d28238e2838fe57307e364af34a21b2",
    "id": null,
    "metadata": {},
    "name": "teamBookingsTab_bookings_refetchableFragment",
    "operationKind": "query",
    "text": "query teamBookingsTab_bookings_refetchableFragment(\n  $bookingSortingValues: [BookingOrderInput!]\n  $bookingsSearchCriteriaFrom: DateTime\n  $bookingsSearchCriteriaTo: DateTime\n  $count: Int = 50\n  $cursor: String\n  $teamId: String!\n) {\n  ...teamBookingsTab_bookings_query_1G22uz\n}\n\nfragment bookingCard_BookingDetails on BookingDetails {\n  id\n  from\n  to\n  notes\n  customer {\n    uniqueId\n    name\n    givenName\n    middleName\n    familyName\n    photoUrl\n  }\n  organization {\n    uniqueId\n    name\n  }\n  location {\n    uniqueId\n    name\n  }\n  team {\n    uniqueId\n    name\n  }\n  desks {\n    uniqueId\n    name\n    locationTags {\n      uniqueId\n      name\n      tagType\n    }\n  }\n}\n\nfragment teamBookingsTab_bookings_query_1G22uz on Query {\n  bookings(first: $count, after: $cursor, where: {teamIds: [$teamId], fromGTE: $bookingsSearchCriteriaFrom, fromLTE: $bookingsSearchCriteriaTo, includeMineOnly: false}, orderBy: $bookingSortingValues) {\n    totalCount\n    edges {\n      node {\n        id\n        from\n        to\n        customer {\n          uniqueId\n        }\n        ...bookingCard_BookingDetails\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n}\n"
  }
};
})();

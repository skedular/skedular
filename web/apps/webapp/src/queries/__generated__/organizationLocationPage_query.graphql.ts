/**
 * @generated SignedSource<<1e48a834863a8bf6a7cf4bb300ab7a81>>
...
export type organizationLocationPage_query$data = {
  ...
  readonly " $fragmentType": "organizationLocationPage_query";
};
export type organizationLocationPage_query$key = {
  readonly " $data"?: organizationLocationPage_query$data;
  readonly " $fragmentSpreads": FragmentRefs<"organizationLocationPage_query">;
};
...
return {
  ...
  "kind": "Fragment",
  "metadata": null,
  "name": "organizationLocationPage_query",
  "selections": [
    {
      "alias": null,
      "args": null,
...
(node as any).hash = "c03b3209abdb17d5a84a97912a30d852";

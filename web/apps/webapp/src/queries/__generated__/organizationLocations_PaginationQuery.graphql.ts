...
export type organizationLocations_PaginationQuery$variables = {
...
export type organizationLocations_PaginationQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"organizationLocationsTab_query">;
};
export type organizationLocations_PaginationQuery = {
  response: organizationLocations_PaginationQuery$data;
  variables: organizationLocations_PaginationQuery$variables;
};

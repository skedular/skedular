/**
 * @generated SignedSource<<a7e09e0cb85de13c42b055c1d3c211c4>>
...
export type organizationLocationPage_updateLocationMutation$variables = {
  input: UpdateLocationInput;
};
export type organizationLocationPage_updateLocationMutation$data = {
...
export type organizationLocationPage_updateLocationMutation$rawResponse = {
  readonly updateLocation: {
    readonly location: {
      readonly amenities: ReadonlyArray<{
        readonly color: string | null | undefined;
...
export type organizationLocationPage_updateLocationMutation = {
  rawResponse: organizationLocationPage_updateLocationMutation$rawResponse;
  response: organizationLocationPage_updateLocationMutation$data;
  variables: organizationLocationPage_updateLocationMutation$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "organizationLocationPage_updateLocationMutation",
    "selections": (v5/*: any*/),
    "type": "Mutation",
    "abstractKey": null
  },
  ...
  "params": {
    "cacheID": "606df92b598b512927de6f7d8a15077f",
    "id": null,
    "metadata": {},
    "name": "organizationLocationPage_updateLocationMutation",
    "operationKind": "mutation",
    "text": "mutation organizationLocationPage_updateLocationMutation(\n  $input: UpdateLocationInput!\n) {\n  updateLocation(input: $input) {\n    location {\n      id\n      name\n      listingMetadata {\n        title\n        subTitle\n        includedFeatures\n      }\n      timezone\n      type {\n        type\n        name\n      }\n      extraMetadata {\n        contactDetails {\n          contactPeople\n          contactEmails\n          contactPhones\n        }\n        areaRange {\n          fromInSqm\n          toInSqm\n        }\n        peopleCapacity {\n          from\n          to\n        }\n        website\n        relatedImageLinks\n        relatedVideoLinks\n        otherLinks\n      }\n      featureImages {\n        original {\n          url\n          height\n          width\n        }\n        thumbnail {\n          url\n          height\n          width\n        }\n      }\n      spaceTypes {\n        id\n        name\n        color\n      }\n      amenities {\n        id\n        name\n        color\n      }\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "0cff255a7e4105796beb2b0bef4013af";

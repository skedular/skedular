/**
 * @generated SignedSource<<fc13a42efd620873b39fd0d759390347>>
...
export type teamMembersPaginationQuery$variables = {
...
export type teamMembersPaginationQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"teamPeopleTab_query">;
};
export type teamMembersPaginationQuery = {
  response: teamMembersPaginationQuery$data;
  variables: teamMembersPaginationQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "teamMembersPaginationQuery",
    "selections": [
      {
        "args": [
          {

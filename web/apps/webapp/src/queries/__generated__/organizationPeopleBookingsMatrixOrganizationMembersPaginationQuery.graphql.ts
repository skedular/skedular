/**
 * @generated SignedSource<<a4b52552eaaa04111c7bca14f7395e57>>
...
export type organizationPeopleBookingsMatrixOrganizationMembersPaginationQuery$variables = {
...
export type organizationPeopleBookingsMatrixOrganizationMembersPaginationQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"organizationPeopleBookingsMatrix_query">;
};
export type organizationPeopleBookingsMatrixOrganizationMembersPaginationQuery = {
  response: organizationPeopleBookingsMatrixOrganizationMembersPaginationQuery$data;
  variables: organizationPeopleBookingsMatrixOrganizationMembersPaginationQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "organizationPeopleBookingsMatrixOrganizationMembersPaginationQuery",
    "selections": [
      {
        "args": null,
        "kind": "FragmentSpread",

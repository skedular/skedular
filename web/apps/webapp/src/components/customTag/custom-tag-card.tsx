import type { customTagCard_OrganizationTagDetails$key } from '@/queries/__generated__/customTagCard_OrganizationTagDetails.graphql';
import type { customTagCard_Query$key } from '@/queries/__generated__/customTagCard_Query.graphql';
import type { customTagCard_addCustomerDefaultOrganizationTagMutation } from '@/queries/__generated__/customTagCard_addCustomerDefaultOrganizationTagMutation.graphql';
import type { customTagCard_deleteCustomTagMutation } from '@/queries/__generated__/customTagCard_deleteCustomTagMutation.graphql';
import type { customTagCard_removeCustomerDefaultOrganizationTagMutation } from '@/queries/__generated__/customTagCard_removeCustomerDefaultOrganizationTagMutation.graphql';
import type { customTagCard_updateCustomTagMutation } from '@/queries/__generated__/customTagCard_updateCustomTagMutation.graphql';

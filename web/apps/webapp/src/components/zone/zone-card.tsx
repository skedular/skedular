import type { zoneCard_OrganizationTagDetails$key } from '@/queries/__generated__/zoneCard_OrganizationTagDetails.graphql';
import type { zoneCard_Query$key } from '@/queries/__generated__/zoneCard_Query.graphql';
import type { zoneCard_addCustomerDefaultOrganizationTagMutation } from '@/queries/__generated__/zoneCard_addCustomerDefaultOrganizationTagMutation.graphql';
import type { zoneCard_deleteZoneMutation } from '@/queries/__generated__/zoneCard_deleteZoneMutation.graphql';
import type { zoneCard_removeCustomerDefaultOrganizationTagMutation } from '@/queries/__generated__/zoneCard_removeCustomerDefaultOrganizationTagMutation.graphql';

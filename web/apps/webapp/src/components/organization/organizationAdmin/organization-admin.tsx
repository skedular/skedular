...
import type { organizationAdmin_deleteLocationTagsMutation } from '@/queries/__generated__/organizationAdmin_deleteLocationTagsMutation.graphql';
...
import type { organizationAdmin_deleteProductTagsMutation } from '@/queries/__generated__/organizationAdmin_deleteProductTagsMutation.graphql';
...
import type { organizationAdmin_locationTags_query$key } from '@/queries/__generated__/organizationAdmin_locationTags_query.graphql';
import type { organizationAdmin_locationTags_refetchableFragment } from '@/queries/__generated__/organizationAdmin_locationTags_refetchableFragment.graphql';
...
import type { organizationAdmin_productTags_query$key } from '@/queries/__generated__/organizationAdmin_productTags_query.graphql';
import type { organizationAdmin_productTags_refetchableFragment } from '@/queries/__generated__/organizationAdmin_productTags_refetchableFragment.graphql';
...
type Props = {
  ...
  rootDataProductTagsRelay: organizationAdmin_productTags_query$key;
  rootDataLocationTagsRelay: organizationAdmin_locationTags_query$key;
...
const OrganizationAdmin = ({
  ...
  const [rootDataProductTags, refetchProductTags] = useRefetchableFragment<organizationAdmin_productTags_refetchableFragment, organizationAdmin_productTags_query$key>(
    graphql`
      fragment organizationAdmin_productTags_query on Query
      @argumentDefinitions(cursor: { type: "String" }, count: { type: "Int", defaultValue: null })
      @refetchable(queryName: "organizationAdmin_productTags_refetchableFragment") {
        productTags(
          first: $count
          after: $cursor
          where: { organizationId: $organizationId, nameContains: $productTagNameSearchText }
          orderBy: [{ direction: Ascending, field: Name }]
        ) @connection(key: "organizationAdmin_productTags") {
          __id
          totalCount
          edges {
            node {
  ...
  const [rootDataLocationTags, refetchLocationTags] = useRefetchableFragment<organizationAdmin_locationTags_refetchableFragment, organizationAdmin_locationTags_query$key>(
    graphql`
      fragment organizationAdmin_locationTags_query on Query
      @argumentDefinitions(cursor: { type: "String" }, count: { type: "Int", defaultValue: null })
      @refetchable(queryName: "organizationAdmin_locationTags_refetchableFragment") {
        locationTags(
          first: $count
          after: $cursor
          where: { organizationId: $organizationId, nameContains: $locationTagNameSearchText }
          orderBy: [{ direction: Ascending, field: Name }]
        ) @connection(key: "organizationAdmin_locationTags") {
          __id
          totalCount
          edges {
            node {
  ...
  const [commitDeleteProductTags] = useMutation<organizationAdmin_deleteProductTagsMutation>(graphql`
    mutation organizationAdmin_deleteProductTagsMutation($connectionIds: [ID!]!, $input: DeleteProductTagsInput!) {
  ...
  const [commitDeleteLocationTags] = useMutation<organizationAdmin_deleteLocationTagsMutation>(graphql`
    mutation organizationAdmin_deleteLocationTagsMutation($connectionIds: [ID!]!, $input: DeleteLocationTagsInput!) {
        ...
        <Box sx={{ marginLeft: secondDrawerExpandedDrawerWidthPx, flexGrow: 1 }}>
          <AppBarWithStackColumn onClose={handleCloseClick} label="Edit Organization Information">
            ...
            >
              <GridContainer sx={{ justifyContent: 'space-between' }}>
                <Grid>
                  <SectionIconTypography label="Product Tags Setup" />
            ...
            >
              <GridContainer sx={{ justifyContent: 'space-between' }}>
                <Grid>
                  <SectionIconTypography label="Location Tags Setup" />

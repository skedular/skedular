...
import type { organizationCustomTagsTab_customTags_query$key } from '@/queries/__generated__/organizationCustomTagsTab_customTags_query.graphql';
import type {
  OrganizationTagOrderField,
  OrganizationTagOrderInput,
  organizationCustomTagsTab_customTags_refetchableFragment,
} from '@/queries/__generated__/organizationCustomTagsTab_customTags_refetchableFragment.graphql';
import type { organizationCustomTagsTab_query$key } from '@/queries/__generated__/organizationCustomTagsTab_query.graphql';
import type { organizationCustomTagsTab_rootQuery } from '@/queries/__generated__/organizationCustomTagsTab_rootQuery.graphql';
...
const OrganizationCustomTagsTab = ({ queryReference, organizationId }: Props) => {

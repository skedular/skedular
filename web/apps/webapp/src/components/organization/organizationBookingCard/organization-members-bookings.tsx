...
import type { organizationMembersBookings_clearCustomerDefaultOrganizationMutation } from '@/queries/__generated__/organizationMembersBookings_clearCustomerDefaultOrganizationMutation.graphql';
import type { organizationMembersBookings_deleteOrganizationMutation } from '@/queries/__generated__/organizationMembersBookings_deleteOrganizationMutation.graphql';
import type { organizationMembersBookings_query$key } from '@/queries/__generated__/organizationMembersBookings_query.graphql';
import type { organizationMembersBookings_setCustomerDefaultOrganizationMutation } from '@/queries/__generated__/organizationMembersBookings_setCustomerDefaultOrganizationMutation.graphql';
...
import { DefaultDialogTitle, PushToRight, StackRow, TwoButtonsDialogActions } from '@repo/shared/components/commons';
  ...
  return (
    <>
      ...
      <Dialog TransitionComponent={DialogTransition} open={organizationRemoveConfirmationDialogOpen} onClose={handleCancelRemovingOrganizationClick}>
        <DefaultDialogTitle title="Remove organization" />
        <DialogContent>
          <DialogContentText>

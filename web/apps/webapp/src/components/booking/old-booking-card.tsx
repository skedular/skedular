import type { oldBookingCard_BookingDetails$key } from '@/queries/__generated__/oldBookingCard_BookingDetails.graphql';
import type { oldBookingCard_addBookingMutation } from '@/queries/__generated__/oldBookingCard_addBookingMutation.graphql';
import type { oldBookingCard_addCustomerDefaultDeskMutation } from '@/queries/__generated__/oldBookingCard_addCustomerDefaultDeskMutation.graphql';
import type { oldBookingCard_deleteBookingMutation } from '@/queries/__generated__/oldBookingCard_deleteBookingMutation.graphql';
import type { oldBookingCard_query$key } from '@/queries/__generated__/oldBookingCard_query.graphql';
import type { oldBookingCard_removeCustomerDefaultDeskMutation } from '@/queries/__generated__/oldBookingCard_removeCustomerDefaultDeskMutation.graphql';
import type { oldBookingCard_updateBookingMutation } from '@/queries/__generated__/oldBookingCard_updateBookingMutation.graphql';

...
const RootPageWithRelay = () => {
  ...
  const { organizationUniqueAlphanumericName, locationId, resourceId } = useKnownParams();
  ...
  }, [loadQuery, triggerReloadId, organizationUniqueAlphanumericName, locationId, resourceId]);

...
import { OrganizationAbout } from '@/components/organization/organizationPage';
...
const OrganizationsPage = () => {
  ...
  return (
    <RootShell appBarBreadcrumbs={breadcrumps}>
      <OrganizationAbout onReloadRequired={handleReloadRequired} organizationId={finalOrganizationId} />
    </RootShell>
  );
};

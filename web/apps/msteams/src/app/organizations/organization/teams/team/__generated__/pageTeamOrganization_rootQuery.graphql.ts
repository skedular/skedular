/**
 * @generated SignedSource<<b80144e36862320686e6b0fcd69d30f0>>
...
export type pageTeamOrganization_rootQuery$variables = {
...
export type pageTeamOrganization_rootQuery$data = {
  readonly teamCustomerRecordSynced: boolean;
  readonly " $fragmentSpreads": FragmentRefs<"rootShell_query" | "teamPage_query">;
};
export type pageTeamOrganization_rootQuery = {
  response: pageTeamOrganization_rootQuery$data;
  variables: pageTeamOrganization_rootQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "pageTeamOrganization_rootQuery",
    "selections": [
      (v16/*: any*/),
      {
        "args": null,

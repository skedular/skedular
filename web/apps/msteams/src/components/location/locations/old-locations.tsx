...
import type { oldLocations_query$key } from './__generated__/oldLocations_query.graphql';
import type {
  LocationOrderField,
  LocationOrderInput,
  oldLocations_refetchableFragment,
} from './__generated__/oldLocations_refetchableFragment.graphql';
import type { oldLocations_rootQuery } from './__generated__/oldLocations_rootQuery.graphql';
...
const RootQuery = graphql`
  query oldLocations_rootQuery($organizationId: String!, $locationsSortingValues: [LocationOrderInput!]!, $locationNameSearchText: String) {
    ...oldLocations_query
  }
`;

const OldLocations = ({ queryReference, organizationId }: Props) => {
...
const OldLocationsWithRelay = ({ organizationId }: RelayProps) => {
  ...
  return (
    <ErrorBoundary fallbackRender={({ error }: { error: RootError }) => <RelayError error={error} />}>
      <MemoOldLocations queryReference={queryReference} onReloadRequired={handleReloadRequired} organizationId={organizationId} />
    </ErrorBoundary>
  );
};

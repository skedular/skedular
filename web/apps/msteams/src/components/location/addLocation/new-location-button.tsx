...
const NewLocationButton = ({ organizationId, fullWidth, label, hideIcon, variant, size, invertDefaultColor }: Props) => {
  const paletteMode = useContext(PaletteModeContext);

  return (
    <Button
      href={getLocationAddLink(organizationId)}

...
import type { locationMembersBookings_removeCustomerDefaultLocationMutation } from './__generated__/locationMembersBookings_removeCustomerDefaultLocationMutation.graphql';

...
import type { locationPeopleBookings_query$data, locationPeopleBookings_query$key } from './__generated__/locationPeopleBookings_query.graphql';
...
type BookingDetails = {
  ...
  booking: locationPeopleBookings_query$data['allBookings'][number] | undefined;
};

/**
 * @generated SignedSource<<a1dced5a2f38d087b10de2b51f31dd4f>>
...
export type teamBookingsTab_rootQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"teamBookingsTab_bookings_query" | "teamBookingsTab_query">;
};

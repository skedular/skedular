...
import type { editRoom_query$key } from './__generated__/editRoom_query.graphql';
import type { editRoom_updateRoomMutation } from './__generated__/editRoom_updateRoomMutation.graphql';

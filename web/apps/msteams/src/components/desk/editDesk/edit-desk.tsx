...
import type { editDesk_query$key } from './__generated__/editDesk_query.graphql';
import type { editDesk_updateDeskMutation } from './__generated__/editDesk_updateDeskMutation.graphql';

...
import type { organizationTeams_addCustomerDefaultTeamMutation } from './__generated__/organizationTeams_addCustomerDefaultTeamMutation.graphql';
import type { organizationTeams_deleteTeamMutation } from './__generated__/organizationTeams_deleteTeamMutation.graphql';
import type { organizationTeams_removeCustomerDefaultTeamMutation } from './__generated__/organizationTeams_removeCustomerDefaultTeamMutation.graphql';
import type { organizationTeams_rootQuery } from './__generated__/organizationTeams_rootQuery.graphql';
import type { organizationTeams_teams_query$key } from './__generated__/organizationTeams_teams_query.graphql';
import type { organizationTeams_teams_refetchableFragment } from './__generated__/organizationTeams_teams_refetchableFragment.graphql';

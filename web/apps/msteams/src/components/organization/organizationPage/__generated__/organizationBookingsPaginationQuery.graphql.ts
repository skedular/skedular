/**
 * @generated SignedSource<<019f2121eb7b4a1760f6794bc559e330>>
...
export type organizationBookingsPaginationQuery$variables = {
...
export type organizationBookingsPaginationQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"organizationBookingsTab_query">;
};
export type organizationBookingsPaginationQuery = {
  response: organizationBookingsPaginationQuery$data;
  variables: organizationBookingsPaginationQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "organizationBookingsPaginationQuery",
    "selections": [
      {
        "args": [
          {

...
import type { organizationDeskTypesTab_deskTypes_query$key } from './__generated__/organizationDeskTypesTab_deskTypes_query.graphql';
import type {
  OrganizationTagOrderField,
  OrganizationTagOrderInput,
  organizationDeskTypesTab_deskTypes_refetchableFragment,
} from './__generated__/organizationDeskTypesTab_deskTypes_refetchableFragment.graphql';

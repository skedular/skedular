...
import type { organizationLocations_addCustomerDefaultLocationMutation } from './__generated__/organizationLocations_addCustomerDefaultLocationMutation.graphql';
import type { organizationLocations_deleteLocationMutation } from './__generated__/organizationLocations_deleteLocationMutation.graphql';
import type { organizationLocations_locations_availableOrganizationDesks_query$key } from './__generated__/organizationLocations_locations_availableOrganizationDesks_query.graphql';
import type { organizationLocations_locations_availableOrganizationDesks_refetchableFragment } from './__generated__/organizationLocations_locations_availableOrganizationDesks_refetchableFragment.graphql';
import type { organizationLocations_removeCustomerDefaultLocationMutation } from './__generated__/organizationLocations_removeCustomerDefaultLocationMutation.graphql';
import type { organizationLocations_rootQuery } from './__generated__/organizationLocations_rootQuery.graphql';

...
import type { organizationLocation_activateRoomsMutation } from './__generated__/organizationLocation_activateRoomsMutation.graphql';
...
import type { organizationLocation_addCustomerDefaultRoomMutation } from './__generated__/organizationLocation_addCustomerDefaultRoomMutation.graphql';
...
import type { organizationLocation_deactivateRoomsMutation } from './__generated__/organizationLocation_deactivateRoomsMutation.graphql';
...
import type { organizationLocation_deleteRoomsMutation } from './__generated__/organizationLocation_deleteRoomsMutation.graphql';
...
import type { organizationLocation_removeCustomerDefaultRoomMutation } from './__generated__/organizationLocation_removeCustomerDefaultRoomMutation.graphql';
import type { organizationLocation_rooms_query$key } from './__generated__/organizationLocation_rooms_query.graphql';
import type { organizationLocation_rooms_refetchableFragment } from './__generated__/organizationLocation_rooms_refetchableFragment.graphql';
  ...
  const handleRoomMoreActionsMenuItemClick = (id: MoreActionsMenuOptionType) => {
    ...
    switch (id) {
      case MoreActionsMenuOptionType.EditRoom:
        if (roomDetails) {
          navigate(getOrganizationLocationRoomBaseLink(organizationId, locationId, roomDetails.id));
          return;
        }

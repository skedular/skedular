...
import type { organizationOnboarding_query$key } from './__generated__/organizationOnboarding_query.graphql';

type Props = {
  rootDataRelay: organizationOnboarding_query$key;
};
...
const OrganizationOnboarding = ({ rootDataRelay }: Props) => {

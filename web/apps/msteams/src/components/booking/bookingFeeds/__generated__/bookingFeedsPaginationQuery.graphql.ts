/**
 * @generated SignedSource<<61acdcaa09703d0cc2bfae6ef0ebf17a>>
...
export type bookingFeedsPaginationQuery$variables = {
...
export type bookingFeedsPaginationQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"bookingFeeds_query">;
};
export type bookingFeedsPaginationQuery = {
  response: bookingFeedsPaginationQuery$data;
  variables: bookingFeedsPaginationQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "bookingFeedsPaginationQuery",
    "selections": [
      {
        "args": [
          {

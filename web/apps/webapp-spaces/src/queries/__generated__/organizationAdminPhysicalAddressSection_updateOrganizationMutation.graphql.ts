...
export type organizationAdminPhysicalAddressSection_updateOrganizationMutation$variables = {
  input: UpdateOrganizationInput;
};
export type organizationAdminPhysicalAddressSection_updateOrganizationMutation$data = {
...
export type organizationAdminPhysicalAddressSection_updateOrganizationMutation$rawResponse = {
  readonly updateOrganization: {
    readonly organization: {
      readonly id: string;
      readonly physicalAddress: {
...
export type organizationAdminPhysicalAddressSection_updateOrganizationMutation = {
  rawResponse: organizationAdminPhysicalAddressSection_updateOrganizationMutation$rawResponse;
  response: organizationAdminPhysicalAddressSection_updateOrganizationMutation$data;
  variables: organizationAdminPhysicalAddressSection_updateOrganizationMutation$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "organizationAdminPhysicalAddressSection_updateOrganizationMutation",
  ...
  "params": {
    "cacheID": "5a8ed94a56034d1261bee06e66cd6b0c",
    "id": null,
    "metadata": {},
    "name": "organizationAdminPhysicalAddressSection_updateOrganizationMutation",
    "operationKind": "mutation",
    "text": "mutation organizationAdminPhysicalAddressSection_updateOrganizationMutation(\n  $input: UpdateOrganizationInput!\n) {\n  updateOrganization(input: $input) {\n    organization {\n      id\n      physicalAddress {\n        id\n        osmType\n        osmId\n        placeId\n        longitude\n        latitude\n        formattedAddress\n        addressLine1\n        addressLine2\n        suburb\n        city\n        province\n        zipcode\n        country\n        countryCode\n      }\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "3e0ed4a0d1aed86e716c947d5eb914fb";

      ...
      <StackColumn sx={{ maxWidth: 760, width: '100%', p: { xs: 2, md: 4 } }}>
        {organizationCount === 0 ? (
          <Card variant="outlined">
            <CardContent>
              <StackColumn>
                <LeadIconTypography label="Create your first private organization" />
                <BodyIconTypography label="Teams is for private organizations, team membership, users, bookings, locations, and internal availability workflows." />
          ...
          <StackColumn>
            <StackRow sx={{ justifyContent: 'space-between', alignItems: 'center', gap: 2, flexWrap: 'wrap' }}>
              <LeadIconTypography label={organizationCount === 1 ? 'Select your private organization' : 'Select a private organization'} />
              <AddOrganizationButton href={createOrganizationLink} />
            </StackRow>

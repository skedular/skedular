...
export_schema "${BASE_DIR}/src/booking/apis/Booking.Api"
export_schema "${BASE_DIR}/src/core/apis/Core.Api"
export_schema "${BASE_DIR}/src/customer/apis/Customer.Api"
export_schema "${BASE_DIR}/src/location/apis/Location.Api"
export_schema "${BASE_DIR}/src/marketplace/apis/Marketplace.Api"
export_schema "${BASE_DIR}/src/msteams/apis/MsTeams.Api"
export_schema "${BASE_DIR}/src/organization/apis/Organization.Api"
export_schema "${BASE_DIR}/src/slack/apis/Slack.Api"
export_schema "${BASE_DIR}/src/team/apis/Team.Api"
...
GATEWAY_FAR="${BASE_DIR}/src/gateway/apis/Gateway/gateway.far"
...
################################################################################################################
cd "${BASE_DIR}/src/booking/domain/Booking.Domain.IntegrationTests"
rm -f schema.graphql
dotnet graphql init -f ../../apis/Booking.Api/schema.graphqls
git checkout -- ./.graphqlrc.json

cd "${BASE_DIR}/src/core/domain/Core.Domain.IntegrationTests"
rm -f schema.graphql
dotnet graphql init -f ../../apis/Core.Api/schema.graphqls
git checkout -- ./.graphqlrc.json

cd "${BASE_DIR}/src/customer/domain/Customer.Domain.IntegrationTests"
rm -f schema.graphql
dotnet graphql init -f ../../apis/Customer.Api/schema.graphqls
git checkout -- ./.graphqlrc.json

cd "${BASE_DIR}/src/location/domain/Location.Domain.IntegrationTests"
rm -f schema.graphql
dotnet graphql init -f ../../apis/Location.Api/schema.graphqls
git checkout -- ./.graphqlrc.json

cd "${BASE_DIR}/src/marketplace/domain/Marketplace.Domain.IntegrationTests"
rm -f schema.graphql
dotnet graphql init -f ../../apis/Marketplace.Api/schema.graphqls
git checkout -- ./.graphqlrc.json

cd "${BASE_DIR}/src/msteams/domain/MsTeams.Domain.IntegrationTests"
rm -f schema.graphql
dotnet graphql init -f ../../apis/MsTeams.Api/schema.graphqls
git checkout -- ./.graphqlrc.json

cd "${BASE_DIR}/src/organization/domain/Organization.Domain.IntegrationTests"
rm -f schema.graphql
dotnet graphql init -f ../../apis/Organization.Api/schema.graphqls
git checkout -- ./.graphqlrc.json

cd "${BASE_DIR}/src/slack/domain/Slack.Domain.IntegrationTests"
rm -f schema.graphql
dotnet graphql init -f ../../apis/Slack.Api/schema.graphqls
git checkout -- ./.graphqlrc.json

cd "${BASE_DIR}/src/team/domain/Team.Domain.IntegrationTests"
rm -f schema.graphql
dotnet graphql init -f ../../apis/Team.Api/schema.graphqls
git checkout -- ./.graphqlrc.json

cd "${BASE_DIR}/src/system/Skedular.SystemTests"
rm -f schema.graphql

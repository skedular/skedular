...
using CustomerModel = Team.Shared.Models.Customer;
using CustomerEntity = Team.Shared.Database.Entities.Customer;

namespace Team.Processors.UnitTests.Subscribers;

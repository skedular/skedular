...
resource "aws_ssm_parameter" "invitation_to_join_team_new_customer_email_template" {
  name  = module.common.parameter_store_name_invitation_to_join_team_new_customer_email_template_arn
  type  = "String"
  value = aws_ses_template.invitation_to_join_team_new_customer_email_template.arn
...
resource "aws_ssm_parameter" "invitation_to_join_team_existing_customer_email_template" {
  name  = module.common.parameter_store_name_invitation_to_join_team_existing_customer_email_template_arn
  type  = "String"
  value = aws_ses_template.invitation_to_join_team_existing_customer_email_template.arn
  tags  = merge(local.tags, module.common.tags)
}

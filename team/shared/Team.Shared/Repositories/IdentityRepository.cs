...
public class IdentityRepository(TeamDbContext dbContext, TimeProvider timeProvider)
    : RepositoryBase<TeamDbContext, Identity>(dbContext, timeProvider), IIdentityRepository
{

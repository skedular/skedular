...
public class CanCreateTeamShould
{
        ...
        CancellationToken cancellationToken)
    {
        var organization = new Organization
        {
            ...
            Offering = new Offering { Code = OfferingCode.PayAsYouGoV1 },
            Teams = []
        };
        ...
        await Should.ThrowAsync<TeamNotAllowedForOrganizationType>(
            async () => await sut.CanCreateTeamAsync("org-1", cancellationToken));
    }

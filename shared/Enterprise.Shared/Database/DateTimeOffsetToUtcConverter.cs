...
{
    public static readonly Expression<Func<DateTimeOffset, DateTimeOffset>> ToProvider =
        dateTimeOffset => ConvertIfNeeded(dateTimeOffset);

    public static readonly Expression<Func<DateTimeOffset, DateTimeOffset>> FromProvider =

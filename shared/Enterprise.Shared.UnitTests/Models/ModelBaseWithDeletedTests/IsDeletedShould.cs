...
public class IsDeletedShould
{
    ...
    {
        var model = new ModelBaseWithDeleted { Id = "1", CreatedAt = DateTimeOffset.UtcNow };
    ...
    {
        var model = new ModelBaseWithDeleted { Id = "1", CreatedAt = DateTimeOffset.UtcNow, DeletedAt = DateTimeOffset.UtcNow };
    ...
    {
        var model = new ReplicatedModelBaseWithDeleted { Id = "1", CreatedAt = DateTimeOffset.UtcNow };

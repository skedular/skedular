...
public static class ProductPricingBillingModeExtensions
{
    ...
    extension(string src)
    {
        public string ToProductPricingBillingModeName() =>
            src switch
            {
                ProductPricingBillingModeConstants.NotSet => "Not Set",
                ProductPricingBillingModeConstants.Upfront => "Upfront",
                ProductPricingBillingModeConstants.InArrears => "In Arrears",
                _ => throw new ArgumentOutOfRangeException()
            };

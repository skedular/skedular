...
namespace Api.Shared.Clients.OpenApi.Skedular.Customer.V1
{
    ...
    public partial interface ICustomerClient
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task RepublishAsync(string customerId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public virtual async System.Threading.Tasks.Task<Version> GetVersionAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "v1/customer/version"
                    urlBuilder_.Append("v1/customer/version");
        ...
        public virtual async System.Threading.Tasks.Task RaiseGraphqlChangeAsync(string topicName, string id, string x_API_Key, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "v1/customer/raiseGraphqlChange/{topicName}/{id}"
                    urlBuilder_.Append("v1/customer/raiseGraphqlChange/");
        ...
        /// <returns>the status of customer event republishing</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task RepublishAsync(string customerId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (customerId == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "v1/customer/{customerId}/republish"
                    urlBuilder_.Append("v1/customer/");
        ...
        public virtual async System.Threading.Tasks.Task RepublishAllAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "v1/customer/republish-all"
                    urlBuilder_.Append("v1/customer/republish-all");

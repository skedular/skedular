...
namespace Api.Shared.Clients.Events.Skedular.Customer.V1.Value {
    ...
    static CustomerV1ValueReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "JAoIY3VzdG9tZXIYASABKAsyEi5jdXN0b21lci5DdXN0b21lciLiBgoIQ3Vz",
            ...
            "dG9tZXIuU2V0dGluZ3MSPAoZcHJlZmVycmVkT3JnYW5pemF0aW9uVGFncxgX",
            "IAMoCzIZLmN1c3RvbWVyLk9yZ2FuaXphdGlvblRhZxIuChJmYXZvdXJpdGVM",
            "b2NhdGlvbnMYGCADKAsyEi5jdXN0b21lci5Mb2NhdGlvbhITCgtwaG9uZU51",
            ...
            "aW9uVmlzaWJpbGl0eRIkCgR0eXBlGBwgASgOMhYuY3VzdG9tZXIuQ3VzdG9t",
            "ZXJUeXBlIjwKCElkZW50aXR5EgoKAmlkGAEgASgJEg0KBWVtYWlsGAIgASgJ",
            "EhUKDWVtYWlsVmVyaWZpZWQYAyABKAgiMAoIU2V0dGluZ3MSCgoCaWQYASAB",
            ...
            "b3JtYXRpb25WaXNpYmlsaXR5X1JlZGFjdGVkEAEqQwoMQ3VzdG9tZXJUeXBl",
            "EhYKEkN1c3RvbWVyVHlwZV9HdWVzdBAAEhsKF0N1c3RvbWVyVHlwZV9SZWdp",
  ...
  public enum CustomerType {
    [pbr::OriginalName("CustomerType_Guest")] Guest = 0,
    [pbr::OriginalName("CustomerType_Registered")] Registered = 1,
  }
  ...
  #endif
  {
    ...
    public Customer(Customer other) : this() {
      ...
      favouriteLocations_ = other.favouriteLocations_.Clone();
    ...
    public const int PreferredOrganizationTagsFieldNumber = 23;
    private static readonly pb::FieldCodec<global::Api.Shared.Clients.Events.Skedular.Customer.V1.Value.OrganizationTag> _repeated_preferredOrganizationTags_codec
        = pb::FieldCodec.ForMessage(186, global::Api.Shared.Clients.Events.Skedular.Customer.V1.Value.OrganizationTag.Parser);
    ...
    /// <summary>Field number for the "favouriteLocations" field.</summary>
    public const int FavouriteLocationsFieldNumber = 24;
    private static readonly pb::FieldCodec<global::Api.Shared.Clients.Events.Skedular.Customer.V1.Value.Location> _repeated_favouriteLocations_codec
        = pb::FieldCodec.ForMessage(194, global::Api.Shared.Clients.Events.Skedular.Customer.V1.Value.Location.Parser);
    private readonly pbc::RepeatedField<global::Api.Shared.Clients.Events.Skedular.Customer.V1.Value.Location> favouriteLocations_ = new pbc::RepeatedField<global::Api.Shared.Clients.Events.Skedular.Customer.V1.Value.Location>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public pbc::RepeatedField<global::Api.Shared.Clients.Events.Skedular.Customer.V1.Value.Location> FavouriteLocations {
      get { return favouriteLocations_; }
    }
    ...
    private global::Api.Shared.Clients.Events.Skedular.Customer.V1.Value.CustomerType type_ = global::Api.Shared.Clients.Events.Skedular.Customer.V1.Value.CustomerType.Guest;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::Api.Shared.Clients.Events.Skedular.Customer.V1.Value.CustomerType Type {
      get { return type_; }
      set {
        type_ = value;
      }
    ...
    public bool Equals(Customer other) {
      ...
      if(!favouriteLocations_.Equals(other.favouriteLocations_)) return false;
    ...
    public override int GetHashCode() {
      ...
      hash ^= favouriteLocations_.GetHashCode();
      ...
      if (Type != global::Api.Shared.Clients.Events.Skedular.Customer.V1.Value.CustomerType.Guest) hash ^= Type.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      favouriteLocations_.WriteTo(output, _repeated_favouriteLocations_codec);
      ...
      if (Type != global::Api.Shared.Clients.Events.Skedular.Customer.V1.Value.CustomerType.Guest) {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      favouriteLocations_.WriteTo(ref output, _repeated_favouriteLocations_codec);
      if (PhoneNumber.Length != 0) {
        output.WriteRawTag(202, 1);
        output.WriteString(PhoneNumber);
      }
    ...
    public int CalculateSize() {
      ...
      size += favouriteLocations_.CalculateSize(_repeated_favouriteLocations_codec);
      if (PhoneNumber.Length != 0) {
    ...
    public void MergeFrom(Customer other) {
      ...
      favouriteLocations_.Add(other.favouriteLocations_);
      ...
      if (other.Type != global::Api.Shared.Clients.Events.Skedular.Customer.V1.Value.CustomerType.Guest) {
        Type = other.Type;
      }
      _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
    }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      switch(tag) {
          ...
          case 194: {
            favouriteLocations_.AddEntriesFrom(input, _repeated_favouriteLocations_codec);
            break;
          }
          case 202: {
          ...
          case 224: {
            Type = (global::Api.Shared.Clients.Events.Skedular.Customer.V1.Value.CustomerType) input.ReadEnum();
            break;
          }
        }
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      switch(tag) {
          ...
          case 194: {
            favouriteLocations_.AddEntriesFrom(ref input, _repeated_favouriteLocations_codec);
            break;
          }
          case 202: {
            PhoneNumber = input.ReadString();
  ...
  #endif
  {
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::Api.Shared.Clients.Events.Skedular.Customer.V1.Value.Coordinates Coordinates {

...
Retain nullable `ProductPricing.RequiredDaysPerWeek`, `AvailableDays`, `MembershipTerm`, and `FulfillmentType`; booking duration follows Spec 047 duration limits and no ProductPricing migration is required.

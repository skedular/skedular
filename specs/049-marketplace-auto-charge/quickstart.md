...
8. Test legacy AutoRenew without purchase-specific Stripe Subscription correlation. Confirm it remains non-automatic until an explicit new connected-account subscription authorization is completed and the Customer-profile card is not used.

...
public static class KafkaSerialization
{
    ...
    /// </summary>
    private static readonly HashSet<Type> s_nativelyAvailableSerializers =
    [
        typeof(Null),
        typeof(Ignore),
        typeof(int),
    ...
    public static bool CanSerializeNatively<T>() => s_nativelyAvailableSerializers.Contains(typeof(T));
}

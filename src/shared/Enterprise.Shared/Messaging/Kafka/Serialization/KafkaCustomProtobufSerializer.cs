...
public class KafkaCustomProtobufSerializer<T> : ISerializer<T> where T : class, IMessage<T>, new()
{
    private readonly ILogger<KafkaCustomProtobufSerializer<T>> _logger;
    private readonly ProtobufSerializer<T>? _schemaRegistrySerializer;

    public KafkaCustomProtobufSerializer(
        KafkaConfiguration kafkaConfiguration,
        ILogger<KafkaCustomProtobufSerializer<T>> logger,

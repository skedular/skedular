...
public class KafkaProducerInstanceFromFactoryAdapter<TKey, TValue>(
    IKafkaProducerFactory factory,
    KafkaConfiguration kafkaConfiguration,
    ILogger<KafkaProducerInstanceFromFactoryAdapter<TKey, TValue>> logger)
    : IProducer<TKey, TValue>
{
    ...
    ~KafkaProducerInstanceFromFactoryAdapter() => Dispose(false);
}

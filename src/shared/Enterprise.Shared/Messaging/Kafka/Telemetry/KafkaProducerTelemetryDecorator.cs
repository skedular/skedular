...
public class KafkaProducerTelemetryDecorator<TKey, TValue>(
    IProducer<TKey, TValue> producer,
    IActivityAccessor activityAccessor,
    IKafkaActivityTracer tracer,
    ILogger<KafkaProducerTelemetryDecorator<TKey, TValue>> logger)
    : IProducer<TKey, TValue>
{
    ...
    ~KafkaProducerTelemetryDecorator() => Dispose(false);
}

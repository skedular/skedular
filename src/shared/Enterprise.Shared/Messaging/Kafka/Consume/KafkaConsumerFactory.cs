...
public class KafkaKafkaConsumerFactory(
    ApplicationConfiguration applicationConfiguration,
    IServiceProvider serviceProvider,
    IKafkaClientNaming clientNaming,
    IKafkaLogger kafkaLogger,
    ILogger<KafkaKafkaConsumerFactory> logger)
    : IKafkaConsumerFactory
{
    ...
    {
        logger.LogDebug(
            "Configuring Kafka consumer builder. KeyType={KeyType}, ValueType={ValueType}", typeof(TKey).FullName,
        ...
        logger.LogInformation(
            "Kafka consumer built successfully. KeyType={KeyType}, ValueType={ValueType}", typeof(TKey).FullName,
            typeof(TValue).FullName);

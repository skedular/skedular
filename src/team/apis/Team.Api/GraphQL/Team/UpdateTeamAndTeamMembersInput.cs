...
public class UpdateTeamAndTeamMembersInput
{
    ...
    public HashSet<TeamAndMembersPatchField> FieldsToUpdate { get; set; } = [];
    ...
    [GraphQLName("organizationMemberIds")]
    public IEnumerable<string> OrganizationMemberIds { get; set; } = [];
}

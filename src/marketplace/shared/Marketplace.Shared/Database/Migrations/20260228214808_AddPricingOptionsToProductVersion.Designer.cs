...
namespace Marketplace.Shared.Database.Migrations
{
    ...
    [Migration("20260228214808_AddPricingOptionsToProductVersion")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Marketplace.Shared.Database.Entities.Product", b =>
                {
                    ...
                    b.Property<string>("OrganizationTagId")
                        .HasColumnType("character varying(100)");

                    b.Property<string>("OrganizationTagId1")
                        .HasColumnType("character varying(100)");
                    ...
                    b.HasIndex("OrganizationTagId");

                    b.HasIndex("OrganizationTagId1");
            ...
            modelBuilder.Entity("Marketplace.Shared.Database.Entities.Product", b =>
                {
                    ...
                    b.HasOne("Marketplace.Shared.Database.Entities.OrganizationTag", null)
                        .WithMany("ProductLocationTags")
                        .HasForeignKey("OrganizationTagId");

                    b.HasOne("Marketplace.Shared.Database.Entities.OrganizationTag", null)
                        .WithMany("ProductProductTag")
                        .HasForeignKey("OrganizationTagId1");
            ...
            modelBuilder.Entity("Marketplace.Shared.Database.Entities.OrganizationTag", b =>
                {
                    b.Navigation("ProductLocationTags");

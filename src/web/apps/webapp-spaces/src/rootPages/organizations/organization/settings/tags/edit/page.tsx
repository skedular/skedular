...
import { getOrganizationSettingsCustomTagsBaseLink } from '@/components/links';
...
const RootPage = () => {
  ...
  const returnUrl = searchParams.get('redirectUrl') ?? getOrganizationSettingsCustomTagsBaseLink(integratedPlatform, organizationCustomDomain);

...
import { getOrganizationAdminAddProductTagBaseLink } from '@/components/links';
...
const AddOrganizationProductTagButton = ({ organizationCustomDomain, fullWidth, label, hideIcon, variant, size }: Props) => {
  ...
  const href = useMemo(() => {
    ...
    return getOrganizationAdminAddProductTagBaseLink(integratedPlatrform, organizationCustomDomain, { redirectUrl });
  }, [integratedPlatrform, organizationCustomDomain, pathname, searchParams]);

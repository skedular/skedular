...
import { TaxDetails, taxDetailsSchema } from '@/components/organization/organizationSettings/organization-settings-shared';
import type { organizationSettingsTaxDetailsSectionQuery } from '@/queries/__generated__/organizationSettingsTaxDetailsSectionQuery.graphql';
import type { organizationSettingsTaxDetailsSection_updateOrganizationTaxDetailsMutation } from '@/queries/__generated__/organizationSettingsTaxDetailsSection_updateOrganizationTaxDetailsMutation.graphql';
...
type InnerProps = {
  organizationCustomDomain: string;
  queryReference: PreloadedQuery<organizationSettingsTaxDetailsSectionQuery>;
};
...
const RootQuery = graphql`
  query organizationSettingsTaxDetailsSectionQuery($organizationCustomDomain: String!) {
...
const OrganizationSettingsTaxDetailsSectionContent = ({ organizationCustomDomain, queryReference }: InnerProps) => {
  const rootData = usePreloadedQuery<organizationSettingsTaxDetailsSectionQuery>(RootQuery, queryReference);
  const [commitUpdateOrganizationTaxDetailsPatch] = useMutation<organizationSettingsTaxDetailsSection_updateOrganizationTaxDetailsMutation>(graphql`
    mutation organizationSettingsTaxDetailsSection_updateOrganizationTaxDetailsMutation($input: UpdateOrganizationTaxDetailsInput!) @raw_response_type {
...
const OrganizationSettingsTaxDetailsSection = ({ organizationCustomDomain }: Props) => {
  const [queryReference, loadQuery] = useQueryLoader<organizationSettingsTaxDetailsSectionQuery>(RootQuery);
  ...
  return <OrganizationSettingsTaxDetailsSectionContent organizationCustomDomain={organizationCustomDomain} queryReference={queryReference} />;
};

export default memo(OrganizationSettingsTaxDetailsSection);

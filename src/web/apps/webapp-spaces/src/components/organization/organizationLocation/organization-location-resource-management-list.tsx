          ...
          >
            <StackColumn spacing={1}>
              <Box
                sx={{
                  display: 'grid',
                  gridTemplateColumns: { xs: '40px minmax(0, 1fr) auto', lg: '40px minmax(180px, 1.4fr) 100px 80px minmax(180px, 1fr) minmax(140px, 0.8fr) 40px' },
                  gap: 1,
                  alignItems: 'center',
                  minWidth: 0,
                }}
              >
                ...
                <ProductTags productTags={item.productTags} hideIcon hideNAText sx={{ display: { xs: 'none', lg: 'flex' }, minWidth: 0, overflow: 'hidden' }} />
                <IconButton
                ...
                <StackRow sx={{ gridColumn: '2 / -1', display: { xs: 'flex', lg: 'none' }, gap: 0.5, flexWrap: 'wrap' }}>
                  ...
                  <ProductTags productTags={item.productTags} hideIcon hideNAText />
                </StackRow>
              </Box>
            </StackColumn>
          </Box>

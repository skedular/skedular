...
type Section = 'tags-setup' | 'zones-setup' | 'product-tags-setup';
const sections: Section[] = ['tags-setup', 'zones-setup', 'product-tags-setup'];
const labels: Record<Section, string> = { 'tags-setup': 'Tags', 'zones-setup': 'Zones', 'product-tags-setup': 'Booking groups' };
  ...
  return (
    <Box sx={{ width: '100%', maxWidth: '100vw', px: { xs: 0, sm: 1, md: 2 }, pb: defaultPadding }}>
      <StackColumn sx={{ width: '100%', maxWidth: 1200, mx: 'auto', pt: { xs: 1, sm: 1, md: 2 }, gap: 2 }}>
        <PageHeaderPanel eyebrow="Tags & Groups" title="Shared tags, zones & booking groups" description="Manage tags, zones, and booking groups used across this organization.">

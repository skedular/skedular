...
vi.mock(import('@skedular/shared'), async (importOriginal) => {
  ...
  return {
    ...actual,
    useIntegratedPlatrform: () => ({ integratedPlatrform: 'spaces' }),
  };
});
...
describe('NoOrganizationLandingContent', () => {
  ...
  it('renders the no-organization create prompt', () => {
    ...
    expect(screen.getByText('Spaces is for coworking and individual organizations, locations, products, resources, bookings, and operational workflows.')).toBeInTheDocument();

...
npx openapi-typescript-codegen --input ../../../../api-definitions/openapi/skedular/msteams/msteams_core_v1.yaml --output ./src/clients/openapi/skedular/v1/msteams/core/fetch --name SkedularMsTeamsCoreV1Client --client fetch --exportSchemas true &

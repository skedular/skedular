export const launchReviewChecklist = {
  draftCoverage: {
    status: "pending",
    evidence: "draft-coverage.ts",
    requiredPassRate: 1,
  },
  pricingApproval: {
    status: "pending",
    evidence: "claim-review.ts",
    requiredPassRate: 1,
  },
  claimsReview: {
    status: "pending",
  ...
  accessibilityReview: {
    status: "pending",
    evidence: "public-site-content.test.ts and manual mobile review",
    requiredPassRate: 1,
  },
  seoReview: {
    status: "pending",
    evidence: "public page metadata tests",
    requiredPassRate: 1,
  },
  humanQualityTone: {
    status: "pending",
    evidence: "manual review protocol",
...
export const manualReviewFindings = [
  {
    ...
    status: "pending",
    notes:
      "Review all generated public pages in context and rewrite anything that sounds generic, stiff, repetitive, or AI-generated.",
  },
  {
    id: "accessibility-mobile",
    status: "pending",
    notes:
      "Check keyboard navigation, mobile layout, focus order, heading structure, link text, contrast, and critical axe results.",
  },
];

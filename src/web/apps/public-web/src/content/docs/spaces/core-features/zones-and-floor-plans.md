---
id: spaces-zones-floor-plans
title: "Zones and floor plans"
description: "Practical, verified Skedular guidance for zones and floor plans in spaces."
product: spaces
category: workspace-setup
slug: zones-and-floor-plans
articleKind: guide
...
For the full definition and management rules, see the shared [Zones](/docs/shared/core-concepts/zones) concept.
...
Read the shared [Floor Plans](/docs/shared/core-concepts/floor-plans) concept for the broader model.
...
When the physical workspace is ready, continue to [Products and marketplace](/docs/spaces/products-and-marketplace) to configure how it is offered to customers.

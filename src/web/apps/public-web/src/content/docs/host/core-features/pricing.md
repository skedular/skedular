...
Host lets you create one or more pricing options for the place. For each option, set a renter-facing label, a **membership term**, and a **Price**. The available terms are **Daily**, **Weekly**, **Fortnightly**, **Monthly**, **Two months**, **Quarterly**, **Four months**, **Five months**, **Six months**, and **Yearly**.

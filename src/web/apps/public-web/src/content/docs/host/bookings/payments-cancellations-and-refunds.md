...
For a Stripe-paid Booking, Skedular submits the refund through the connected Stripe account. Stripe can leave the refund pending or report it as failed; Host shows the refund's current status. A refund may show **Requested**, **Pending accounting**, **Completed**, **Failed**, **Manual follow-up required**, or **Completed manually**. Do not treat an eligible refund as complete until it shows **Completed** or **Completed manually**.

If the refund cannot be completed automatically, Host exposes the relevant manual follow-up actions in the refund record. These actions record the outcome in Skedular; they do not make Skedular transfer money outside Stripe.

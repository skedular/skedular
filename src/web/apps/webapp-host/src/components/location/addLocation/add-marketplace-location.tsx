                  ...
                  <StackColumn>
                    <FormFieldLabel label="Name" required={requiredFields.name}>
                      <TextField
                        ...
                        helperText={<HelperText text="Enter the public name of the place you are listing. This will be visible in the marketplace." />}
                      />
                    </FormFieldLabel>
                  ...
                  <FormFieldLabel label="Feature Images">
                    <StackColumn>
                      ...
                      <ImageFileUploaderWithCropper
                        ...
                        helperText="Upload a high-quality image that best represents this place. It will appear in search results and marketplace pages."
                      />
                    </StackColumn>
                  </FormFieldLabel>
                </SettingsSectionCard>
                  ...
                  <StackColumn>
                    ...
                    <FormFieldLabel label="Phone Numbers" required={requiredFields.contactPhones}>
                      <TextField
                        ...
                        multiline
                        rows={2}
                        helperText={<HelperText text="Provide a phone number renters can use for inquiries or support." />}
                      />
                    </FormFieldLabel>
                  </StackColumn>
                </SettingsSectionCard>

...
const AddMarketplaceOrganization = ({ rootDataRelay, onReloadRequired, onAdded, onCancel, cancelLabel, createLabel }: Props) => {
  ...
  return (
    <SetupSplitLayout
      asideTitle="Set up your Host organization"
      asideDescription="List your place, manage availability, and connect with people looking for somewhere to rent."
      asideChildren={
        <>
          <SetupFeatureCard
      ...
      mainDescription="Start with the organization details that represent you as a Host before moving into locations, listings, availability, and operations."
    >
      <Form
        ...
        render={({ handleSubmit }) => (
          <FormStackColumn onSubmit={handleSubmit}>
            <StackColumn>
                ...
                <StackColumn>
                  ...
                  <FormFieldLabel label="Name" required={requiredFields.name}>
                    <TextField
                      ...
                      helperText={<HelperText text="Enter the Host name you want renters and marketplace visitors to see." />}
                    />
                  </FormFieldLabel>
                  ...
                  <ListingMetadata
                    fields={['about']}
                    helperTexts={{
                      about: <HelperText text="Briefly describe what you rent out and what makes your places distinctive." />,
                    }}
              ...
              <SettingsSectionCard title="Public Links" description="Add the website and customer-facing policy links people should see before they book or join.">
                <StackColumn>
                  <FormFieldLabel label="Website" required={requiredFields.website}>
                    <TextField name="website" required={requiredFields.website} helperText={<HelperText text="Provide a website to share with renters, if you have one." />} />
                  </FormFieldLabel>
              ...
              <SettingsSectionCard title="Acceptance" description="Confirm the platform terms before the Host organization is created.">

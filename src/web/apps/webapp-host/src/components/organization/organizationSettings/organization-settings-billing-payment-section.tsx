...
import { BillingDetails, billingSchema } from '@/components/organization/organizationSettings/organization-settings-shared';
import type { organizationSettingsBillingPaymentSectionQuery } from '@/queries/__generated__/organizationSettingsBillingPaymentSectionQuery.graphql';
import type { organizationSettingsBillingPaymentSection_removeOrganizationPaymentMethodMutation } from '@/queries/__generated__/organizationSettingsBillingPaymentSection_removeOrganizationPaymentMethodMutation.graphql';
import type { organizationSettingsBillingPaymentSection_updateOrganizationBillingDetailsMutation } from '@/queries/__generated__/organizationSettingsBillingPaymentSection_updateOrganizationBillingDetailsMutation.graphql';
...
type InnerProps = {
  ...
  queryReference: PreloadedQuery<organizationSettingsBillingPaymentSectionQuery>;
  section: 'billing-details' | 'payment-methods' | 'all';
};
...
const RootQuery = graphql`
  query organizationSettingsBillingPaymentSectionQuery($organizationCustomDomain: String!) {
...
const OrganizationSettingsBillingPaymentSectionContent = ({ organizationCustomDomain, onRefetchRequired, queryReference, section }: InnerProps) => {
  const rootData = usePreloadedQuery<organizationSettingsBillingPaymentSectionQuery>(RootQuery, queryReference);
  const [commitUpdateOrganizationBillingDetailsPatch] = useMutation<organizationSettingsBillingPaymentSection_updateOrganizationBillingDetailsMutation>(graphql`
    mutation organizationSettingsBillingPaymentSection_updateOrganizationBillingDetailsMutation($input: UpdateOrganizationBillingDetailsInput!) @raw_response_type {
  ...
  `);
  const [commitRemoveOrganizationPaymentMethod] = useMutation<organizationSettingsBillingPaymentSection_removeOrganizationPaymentMethodMutation>(graphql`
    mutation organizationSettingsBillingPaymentSection_removeOrganizationPaymentMethodMutation($input: RemoveOrganizationPaymentMethodInput!) {
...
const OrganizationSettingsBillingPaymentSection = ({ organizationCustomDomain, section = 'all' }: Props) => {
  const [queryReference, loadQuery] = useQueryLoader<organizationSettingsBillingPaymentSectionQuery>(RootQuery);
  ...
  return (
    <OrganizationSettingsBillingPaymentSectionContent
      key={reloadKey}
      organizationCustomDomain={organizationCustomDomain}
      section={section}
...
export default memo(OrganizationSettingsBillingPaymentSection);

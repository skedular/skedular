...
import {
  ...
  getOrganizationLocationPricingBaseLink,
...
const validSections: OrganizationLocationSection[] = ['setup', 'physical-address-setup', 'opening-hours', 'restricted-information', 'manage-location'];
          ...
          <CardContent>
            <StackColumn spacing={1.5}>
              <StackColumn spacing={0.5}>
                ...
                <BodyIconTypography label="Rates, membership terms, and cancellation policies for this location." />
              </StackColumn>
              <Divider />
              <StackRow sx={{ flexWrap: 'wrap', gap: 1 }}>
                <Button

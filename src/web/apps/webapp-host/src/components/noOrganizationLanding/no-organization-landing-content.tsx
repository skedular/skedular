          ...
          <Card variant="outlined">
            <CardContent>
              <StackColumn>
                ...
                <BodyIconTypography label="Host is for managing your organization, locations, products, bookings, renters, and payouts. Booking resources are managed automatically." />

...
const createPricingOption = (defaultMaxAllowedResourcesLockTimePaidViaCard: number): PricingOptionForm => ({
  id: uuid(),
  title: null,
  subTitle: null,
      ...
      .of(
        object({
          ...
          maxAllowedResourcesLockTimePaidViaBankTransfer: string()
            ...
            .test('is-number', 'Enter a valid hold time.', (value) => !isNaN(Number(value)))
            .test('is-not-negative', 'Bank transfer hold time cannot be negative.', (value) => Number(value) >= 0),
          billingMode: string()
            ...
            pricingOptions:
              rootData.product.pricingOptions.length > 0
                ? rootData.product.pricingOptions.map((pricingOption) => ({
                    ...
                    membershipTerm: pricingOption.membershipTerm,
                ...
                : [createPricingOption(rootData.defaultMaxAllowedResourcesLockTimePaidViaCard)],
          }
        : null,
    [amenityIds, currency, includedFeatures, productTagIds, rootData.defaultMaxAllowedResourcesLockTimePaidViaCard, rootData.product, subTitle, title, type],
  );

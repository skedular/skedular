...
export type pageOrganizationIntegration_rootQuery$variables = {
  organizationCustomDomain: string;
};
export type pageOrganizationIntegration_rootQuery$data = {
...
export type pageOrganizationIntegration_rootQuery = {
  ...
  variables: pageOrganizationIntegration_rootQuery$variables;
};

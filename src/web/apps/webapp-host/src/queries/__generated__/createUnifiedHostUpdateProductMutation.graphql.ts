/**
 * @generated SignedSource<<b7b24229cf89b7d95e9196d92f81f6dc>>
...
export type createUnifiedHostUpdateProductMutation$variables = {
  input: UpdateProductInput;
};
export type createUnifiedHostUpdateProductMutation$data = {
...
export type createUnifiedHostUpdateProductMutation = {
  response: createUnifiedHostUpdateProductMutation$data;
  variables: createUnifiedHostUpdateProductMutation$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "createUnifiedHostUpdateProductMutation",
  ...
  "params": {
    "cacheID": "0ef929be22cfbc9bf53cfacb65b6426c",
    "id": null,
    "metadata": {},
    "name": "createUnifiedHostUpdateProductMutation",
    "operationKind": "mutation",
    "text": "mutation createUnifiedHostUpdateProductMutation(\n  $input: UpdateProductInput!\n) {\n  updateProduct(input: $input) {\n    product {\n      id\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "74eab374ef161028520f6f9a322160d3";

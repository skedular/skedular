...
const AddOrganizationCustomTagButton = ({ organizationCustomDomain, fullWidth, label, hideIcon, variant, size }: Props) => {
  ...
  const href = useMemo(() => {
    ...
    return getOrganizationAdminAddCustomTagBaseLink(integratedPlatrform, organizationCustomDomain, { redirectUrl });

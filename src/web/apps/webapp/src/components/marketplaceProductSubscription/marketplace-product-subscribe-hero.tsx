...
import type { marketplaceProductSubscribeHero_product$key } from '@/queries/__generated__/marketplaceProductSubscribeHero_product.graphql';
...
type Props = {
  productRelay: marketplaceProductSubscribeHero_product$key;
};

const MarketplaceProductSubscribeHero = ({ productRelay }: Props) => {
  ...
  return (
    ...
    >
      ...
      >
        <CaptionIconTypography label="Flexible access plan" sx={{ letterSpacing: '0.14em', textTransform: 'uppercase', opacity: 0.86, color: 'common.white' }} />
        <LeadIconTypography
...
export default memo(MarketplaceProductSubscribeHero);

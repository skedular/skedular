/**
 * @generated SignedSource<<161c465a249214354f45ff206bb48063>>
...
export type organizationSettingsSetupSectionQuery$variables = {
  organizationCustomDomain: string;
};
export type organizationSettingsSetupSectionQuery$data = {
...
export type organizationSettingsSetupSectionQuery = {
  response: organizationSettingsSetupSectionQuery$data;
  variables: organizationSettingsSetupSectionQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "organizationSettingsSetupSectionQuery",
    "selections": [
      (v1/*:: as any*/),
      (v3/*:: as any*/),
      {

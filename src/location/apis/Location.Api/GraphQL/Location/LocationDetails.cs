...
public class LocationDetails : Node
{
    ...
    public LocationPhysicalAddressDetails? PhysicalAddress { get; set; }

    [GraphQLName("customTags")]
    public IEnumerable<OrganizationTagDetails> CustomTags { get; set; } = [];

    [GraphQLName("zones")]
    public IEnumerable<OrganizationTagDetails> Zones { get; set; } = [];

    [GraphQLName("spaceTypes")]
    public IEnumerable<OrganizationTagDetails> SpaceTypes { get; set; } = [];
    ...
    [GraphQLName("productTags")]
    public IEnumerable<OrganizationTagDetails> ProductTags { get; set; } = [];

    [GraphQLName("featureImages")]
    public IEnumerable<CdnImageFile> FeatureImages { get; set; } = [];

    [GraphQLName("floorPlanCount")]
    ...
    [GraphQLName("contactedViaEmail")]
    public bool ContactedViaEmail { get; set; }

    [GraphQLName("contactedViaSms")]
    public bool ContactedViaSms { get; set; }

    [GraphQLName("contactedViaCall")]
    public bool ContactedViaCall { get; set; }

    [GraphQLName("contactedViaWhatsapp")]
    ...
    [GraphQLName("restrictedInformation")]
    public IEnumerable<LocationRestrictedInformationDetails> RestrictedInformation { get; set; } = [];

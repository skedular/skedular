    ...
    extension(IServiceCollection services)
    {
        ...
        public IServiceCollection AddDomainSharedServices() =>
            services
                ...
                .AddScoped<IMarketplaceStripeSubscriptionCancellationService, MarketplaceStripeSubscriptionCancellationService>()
                .AddScoped<IMarketplaceStripeSubscriptionPriceService, MarketplaceStripeSubscriptionPriceService>()
                .AddScoped<IMarketplaceAutomaticPaymentStatusService, MarketplaceAutomaticPaymentStatusService>()
                .AddScoped<IMarketplacePaidInvoiceProvisioner, MarketplacePaidInvoiceProvisioner>()
                .AddScoped<IMarketplaceStripeBillingPortalService, MarketplaceStripeBillingPortalService>()

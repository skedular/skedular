...
{
    public const string PaidViaCardPrefix = "paid_via_card";
    ...
    public const string ExpireEntitlementsPrefix = "expire_entitlements";
    public const string PrepareEntitlementRenewalPrefix = "prepare_entitlement_renewal";

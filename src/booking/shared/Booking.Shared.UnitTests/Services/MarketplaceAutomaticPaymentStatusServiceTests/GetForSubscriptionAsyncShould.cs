...
using MarketplaceAutomaticPaymentStatusType = Booking.Shared.Models.MarketplaceAutomaticPaymentStatusType;
...
public class GetForSubscriptionAsyncShould
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        result.Status.ShouldBe(MarketplaceAutomaticPaymentStatusType.PastDue);

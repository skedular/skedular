...
public class SignalWorkflowPayRecurringBookingViaBankTransferSetPaymentStatusShould
{
    [Theory]
    [AutoFakeItEasyData]
    ...
    {
        A.CallTo(() => workflowIdService.PayRecurringBookingViaBankTransfer(recurringBookingId)).Returns(expectedWorkflowId);

        sut.SignalWorkflowPayRecurringBookingViaBankTransferSetPaymentStatus(recurringBookingId, executionArgs, unitOfWork);

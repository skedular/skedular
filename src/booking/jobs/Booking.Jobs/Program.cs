...
public class Program
{
    ...
    public static WebApplication CreateHostBuilder(string[] args)
    {
        ...
        services
            ...
            .AddWorkflow<MarketplaceStripeSubscriptionCancellation>()
            ...
            .AddScopedActivities<MarketplaceBookingCleanupIntegrations>()
            .AddScopedActivities<MarketplacePaidInvoiceIntegrations>()
            .AddScopedActivities<MarketplaceStripeSubscriptionCancellationIntegrations>()

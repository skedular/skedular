...
public class UpdatePatchAsyncShould
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        A.CallTo(() => teamAuthorizationService.GetBookingInvolvedTeamAndValidatePermissionsAsync(
            ...
            .Returns(emptyTeams);
        A.CallTo(() => sharedMarketplaceBookingService.UpdateAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        LogAssertions.ACallToLogInfoContaining(logger, "Marketplace booking patch autosave started")
            .MustHaveHappenedOnceExactly();
        LogAssertions.ACallToLogInfoContaining(logger, "Marketplace booking patch autosave completed")
            .MustHaveHappenedOnceExactly();
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        LogAssertions.ACallToLog(logger, LogLevel.Error)
            .Where(call => call.GetArgument<IReadOnlyList<KeyValuePair<string, object>>>(2)!.ToString()!
                .Contains("Marketplace booking patch autosave failed"))
            .MustHaveHappenedOnceExactly();
    }
}

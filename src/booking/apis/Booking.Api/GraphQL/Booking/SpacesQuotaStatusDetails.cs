...
public class BookingSpacesQuotaStatusDetails
{
    ...
    [GraphQLName("currentPeriodStartUtc")]
    public DateTimeOffset CurrentPeriodStartUtc { get; set; }

    [GraphQLName("currentPeriodEndUtc")]
...
public class SpacesQuotaReasonCodeDetails
{
    ...
    [GraphQLName("type")]
    public SpacesQuotaReasonCode Type { get; set; }
}

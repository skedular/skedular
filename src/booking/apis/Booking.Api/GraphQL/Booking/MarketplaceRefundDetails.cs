...
{
    [GraphQLName("type")]
    public MarketplaceRefundStatus Type { get; set; }
...
public class MarketplaceRefundDetails
{
    ...
    [GraphQLName("canProcessInXero")]
    public bool CanProcessInXero { get; set; }

    [GraphQLName("events")]
    public IEnumerable<MarketplaceRefundEventDetails> Events { get; set; } = [];

    [GraphQLName("requestedByCustomerId")]

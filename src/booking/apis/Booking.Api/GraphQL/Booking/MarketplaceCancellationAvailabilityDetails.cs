...
public sealed class MarketplaceCancellationAvailabilityDetails
{
    ...
    public bool IsPolicyOverride { get; init; }
...
public sealed class MarketplaceSubscriptionCancellationAvailabilityDetails
{
    ...
    public required MarketplaceCancellationAvailabilityDetails Immediate { get; init; }

    [GraphQLName("atPeriodEnd")]
    public required MarketplaceCancellationAvailabilityDetails AtPeriodEnd { get; init; }
}

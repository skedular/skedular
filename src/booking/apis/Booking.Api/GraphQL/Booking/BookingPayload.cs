...
public class BookingPayload
{
    ...
    [GraphQLName("quotaError")]
    public BookingSpacesQuotaErrorDetails? QuotaError { get; set; }
    ...
    [GraphQLName("failure")]
    public MarketplaceBookingFailureDetails? Failure { get; set; }
...
{
    [GraphQLName("code")]
    public CancellationErrorCode Code { get; set; }
...
public class BookingSpacesQuotaErrorDetails
{
    ...
    public SpacesQuotaReasonCodeDetails? ReasonCode { get; set; }

    [GraphQLName("currentUsage")]
    public int CurrentUsage { get; set; }

    [GraphQLName("quotaLimit")]
    ...
    [GraphQLName("remainingQuota")]
    public int RemainingQuota { get; set; }

    [GraphQLName("upgradePlans")]
    public IReadOnlyCollection<UpgradePlanDetails> UpgradePlans { get; set; } = [];
}

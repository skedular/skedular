...
public class OrganizationActiveOfferingDetails : Node
{
    ...
    [GraphQLName("discountPercentage")]
    public int DiscountPercentage { get; set; }

    [GraphQLName("currency")]
    public CurrencyDetails Currency { get; set; } = new();

    [GraphQLName("catalogVersion")]
    public CatalogVersionDetails? CatalogVersion { get; set; }
    ...
    [GraphQLName("underPriceLines")]
    public IEnumerable<string> UnderPriceLines { get; set; } = [];

    [GraphQLName("featureSet")]
    public IEnumerable<string> FeatureSet { get; set; } = [];

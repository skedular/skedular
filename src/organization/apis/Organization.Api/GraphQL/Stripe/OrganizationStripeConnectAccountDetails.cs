...
public class OrganizationStripeConnectAccountDetails : Node
{
    ...
    [GraphQLName("chargesEnabled")]
    public bool ChargesEnabled { get; set; }

    [GraphQLName("payoutsEnabled")]
    ...
    [GraphQLName("detailsSubmitted")]
    public bool DetailsSubmitted { get; set; }

    [GraphQLName("capabilitiesTransfers")]
    ...
    [GraphQLName("onboardingUrl")]
    public string OnboardingUrl { get; set; } = string.Empty;

    [GraphQLName("isOnboardingCompleted")]
    public bool IsOnboardingCompleted { get; set; }

    [GraphQLName("isAuthorized")]

...
{
    [GraphQLName("type")] public PricingCatalogProductOfferingCode Type { get; set; }
...
{
    [GraphQLName("type")] public PricingCatalogSubscriptionPlanCode Type { get; set; }
    [GraphQLName("name")] public string Name { get; set; } = string.Empty;
}
...
{
    [GraphQLName("type")] public PricingCatalogPlanAvailability Type { get; set; }
    [GraphQLName("name")] public string Name { get; set; } = string.Empty;
}
...
{
    [GraphQLName("type")] public OrganizationOfferingPlanStatus Type { get; set; }
    [GraphQLName("name")] public string Name { get; set; } = string.Empty;
}
...
{
    [GraphQLName("type")] public EntitlementReasonCode Type { get; set; }
    [GraphQLName("name")] public string Name { get; set; } = string.Empty;
}

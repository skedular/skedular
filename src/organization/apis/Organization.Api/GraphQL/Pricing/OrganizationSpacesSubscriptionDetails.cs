...
public class OrganizationSpacesSubscriptionDetails
{
    ...
    [GraphQLName("usageLimit")]
    public int? UsageLimit { get; set; }

    [GraphQLName("rolloverDate")]
    ...
    [GraphQLName("isComplimentaryBridge")]
    public bool IsComplimentaryBridge { get; set; }

    [GraphQLName("nextBillingAt")]

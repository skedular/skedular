...
public class UpdatePatchAsyncShould
{
    ...
    public async Task Update_Only_Selected_Bank_Account_Fields(
        ...
        [Frozen]
        IOrganizationBankAccountRepository organizationBankAccountRepository,
        [Frozen]
        ...
        CancellationToken cancellationToken)
    {
        ...
        var request = new OrganizationBankAccountPatchRequest(
            ...
            {
                OrganizationBankAccountPatchField.Name,
                OrganizationBankAccountPatchField.AccountNumber,
            },

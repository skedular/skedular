...
public class StartWorkflowOrganizationDailyAnalyticsShould
{
    [Theory]
    [AutoFakeItEasyData]
        ...
        string expectedId)
    {
        ...
        sut.StartWorkflowOrganizationDailyAnalytics(args, unitOfWork);

        A.CallTo(() => temporalOutboxWorkflowExecutor.Execute<GenerateOrganizationDailyAnalytics, GenerateOrganizationDailyAnalyticsInput>(
            args,

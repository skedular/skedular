...
public class StartWorkflowReSyncAzureTenantAsyncShould
{
    [Theory]
    [AutoFakeItEasyData]
    public async Task Start_Workflow_With_Correct_Options(
        ...
        WorkflowHandle<ReSyncAzureTenant> workflowHandle,
        TemporalService sut,
        ...
        CancellationToken cancellationToken)
    {
        ...
        A.CallTo(() => temporalClient.StartWorkflowAsync(
                A<Expression<Func<ReSyncAzureTenant, Task>>>._,
        ...
        await sut.StartWorkflowReSyncAzureTenantAsync(args, cancellationToken);

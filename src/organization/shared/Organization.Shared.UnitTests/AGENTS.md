# Organization Shared Unit Tests Agent Notes

This file applies to `organization/shared/Organization.Shared.UnitTests`.

## Purpose

- Unit tests for `Organization.Shared` services and helpers.
...
- Group tests under the service namespace, e.g. `OrganizationWorkflowIdServiceTests/GenerateXShould.cs`.
...
- If the test requires real infrastructure, it belongs in `organization/domain/Organization.Domain.IntegrationTests` or

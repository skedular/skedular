...
public class CustomerReadinessEventSubscriberShould
{
        ...
        CancellationToken cancellationToken)
    {
        var @event = new Event
        {
            Metadata = new Metadata { Type = ValueType.CustomerIdentityProvisioned },
            Data = new Data
            {
                CustomerIdentityProvisioned = new CustomerIdentityProvisioned { CustomerId = customerId, Domain = ValueDomain.Booking }
            }
        };
        ...
        CancellationToken cancellationToken)
    {
        var @event = new Event
        {
            ...
            Data = new Data
            {
                CustomerIdentityProvisioned = new CustomerIdentityProvisioned { CustomerId = customerId, Domain = (ValueDomain)999 }
            }
        };
    ...
    public async Task Return_Success_For_Unknown_Event_Type(
        ...
        CancellationToken cancellationToken)
    {
        var @event = new Event { Metadata = new Metadata { Type = (ValueType)999 }, Data = new Data() };
        ...
        CancellationToken cancellationToken)
    {
        ...
        foreach (var domain in knownDomains)
        {
            ...
            {
                Metadata = new Metadata { Type = ValueType.CustomerIdentityProvisioned },
                Data = new Data { CustomerIdentityProvisioned = new CustomerIdentityProvisioned { CustomerId = customerId, Domain = domain } }
            };

...
public class EntityMapper : IEntityMapper
{
    ...
    public Models.Customer MapTo(Database.Entities.Customer src) =>
        new()
        {
            ...
            PreferredLocations = [.. MapToLocations(src.PreferredLocations)],
            PreferredResources = [.. MapToResources(src.PreferredResources)],
            PreferredOrganizationTags = [.. MapToOrganizationTags(src.PreferredOrganizationTags)],
            FavouriteLocations = [.. MapToLocations(src.FavouriteLocations)],
            StripeCustomer = MapTo(src.StripeCustomer),
            StripePaymentMethods = [.. MapTo(src.StripePaymentMethods)],
    ...
    private static Location? MapTo(Database.Entities.Location? src) =>
        src is null
            ...
            : new Location
            {
                ...
                Resources = [.. MapToResources(src.Resources)],
            };

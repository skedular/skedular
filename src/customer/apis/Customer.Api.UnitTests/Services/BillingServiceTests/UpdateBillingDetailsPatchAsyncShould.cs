...
public class UpdateBillingDetailsPatchAsyncShould
{
    ...
    public async Task Apply_Only_Selected_Company_Name_And_Preserve_Other_Fields(
        ...
        [Frozen] ICustomerBillingDetailsRepository billingDetailsRepository,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var customerModel = new CustomerModel { Id = "cust-1" };
        var existingBillingEntity = new CustomerBillingDetailsEntity
        {
            Id = "billing-1", Customer = customerEntity, CompanyName = "Old Company", Email = "old@example.com"
        };
        var existingBillingModel = new CustomerBillingDetails { Id = "billing-1", CompanyName = "Old Company", Email = "old@example.com" };
        var updatedCustomerModel = new CustomerModel { Id = "cust-1" };
        var request = new CustomerBillingDetailsPatchRequest(
            new CustomerBillingDetails { Id = "billing-1", CompanyName = "New Company" },
        ...
        CancellationToken cancellationToken)
    {
        var customerEntity = new CustomerEntity { Id = "cust-1" };
        var customerModel = new CustomerModel { Id = "cust-1" };
        var existingBillingEntity = new CustomerBillingDetailsEntity { Id = "billing-1", Customer = customerEntity };
        var updatedCustomerModel = new CustomerModel { Id = "cust-1" };
        var request = new CustomerBillingDetailsPatchRequest(
            new CustomerBillingDetails { Id = "billing-1", CompanyName = "New Company" },
            new HashSet<CustomerBillingDetailsPatchField> { CustomerBillingDetailsPatchField.CompanyName });
        ...
        CancellationToken cancellationToken)
    {
        var customerEntity = new CustomerEntity { Id = "cust-1" };
        var customerModel = new CustomerModel { Id = "cust-1" };
        var existingBillingEntity = new CustomerBillingDetailsEntity { Id = "billing-1", Customer = new CustomerEntity { Id = "other-cust" } };
        var request = new CustomerBillingDetailsPatchRequest(
            new CustomerBillingDetails { Id = "billing-1", CompanyName = "New Company" },
            new HashSet<CustomerBillingDetailsPatchField> { CustomerBillingDetailsPatchField.CompanyName });

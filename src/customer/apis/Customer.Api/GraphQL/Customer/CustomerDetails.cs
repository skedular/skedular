...
public class CustomerDetails : Node
{
    ...
    public IEnumerable<CustomerIdentity> Identities { get; set; } = [];
    ...
    [GraphQLName("isOnboardingDone")]
    public bool IsOnboardingDone { get; set; }

    [GraphQLName("defaultOrganizationId")]
    ...
    [GraphQLName("preferredLocationIds")]
    public IEnumerable<string> PreferredLocationIds { get; set; } = [];

    [GraphQLName("preferredZones")]
    public IEnumerable<OrganizationTagDetails> PreferredZones { get; set; } = [];

    [GraphQLName("preferredCustomTags")]
    public IEnumerable<OrganizationTagDetails> PreferredCustomTags { get; set; } = [];

    [GraphQLName("preferredResourceIds")]
    public IEnumerable<string> PreferredResourceIds { get; set; } = [];

    [GraphQLName("favouriteLocationIds")]
    public IEnumerable<string> FavouriteLocationIds { get; set; } = [];
